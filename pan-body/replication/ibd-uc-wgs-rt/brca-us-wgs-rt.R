...
samples1 <- readTable(file.path(wd.ngs, "brca-us_wgs_n89.list"), header=F, rownames=F, sep="")$V3
samples0 <- readTable(file.path(wd.ngs, "brca-us_wgs_n89.list"), header=F, rownames=F, sep="")$V3
n1 <- length(samples1)
n0 <- length(samples0)
