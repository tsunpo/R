...
samples1 <- readTable(file.path(wd.ngs, "brca-us_wgs_m2_n89.txt"), header=T, rownames=T, sep="")   ## M2/M1
#samples1 <- readTable(file.path(wd.ngs, "brca-us_wgs_q3_n45.txt"), header=T, rownames=T, sep="")    ## Q3/Q1
samples1 <- subset(samples1, M2 == 2)[,1]
samples0 <- readTable(file.path(wd.ngs, "brca-us_wgs_m2_n89.txt"), header=T, rownames=T, sep="")
#samples0 <- readTable(file.path(wd.ngs, "brca-us_wgs_m2_n45.txt"), header=T, rownames=T, sep="")
