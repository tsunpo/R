...
samples1 <- readTable(file.path(wd.ngs, "brca-uk_wgs_m2_n44.txt"), header=T, rownames=T, sep="")   ## M2/M1
#samples1 <- readTable(file.path(wd.ngs, "brca-uk_wgs_q4_n22.txt"), header=T, rownames=T, sep="")    ## Q3/Q1
samples1 <- subset(samples1, M2 == 2)[,1]
samples0 <- readTable(file.path(wd.ngs, "brca-uk_wgs_m2_n44.txt"), header=T, rownames=T, sep="")
#samples0 <- readTable(file.path(wd.ngs, "brca-uk_wgs_q4_n22.txt"), header=T, rownames=T, sep="")
