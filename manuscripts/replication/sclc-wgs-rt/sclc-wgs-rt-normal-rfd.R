...
# Manuscript   : 
# Chapter II   : 
# Name         : manuscripts/replicaiton/sclc-wgs-rt-normal-rfd.R
...
#load(file=file.path(wd.rt.data, paste0(base, "_rpkm.gc.cn.d.rt.RT.SLOPE.RData")))
# > nrow(nrds.RT.BSTRPS)
# [1] 2651861
...
file.name <- file.path(wd.rt.plots, paste0("hist_", base, "-normal_rpkm_SLOPE_RFD>0.9_orange_darkgray_font=2_line=4.5.pdf"))
main.text <- c(paste0(BASE, "-NL bootstrap distribution"), paste0(""))
...
genes <- c("B2M")
genes <- c("BLM")
genes <- c("PIF1", "KIF18B", "GTPBP3", "BLM", "BRCA2")
genes <- c("BRCA2", "B2M", "RECQL4")
for (g in 1:length(genes)) {
   ...
   file.name <- file.path(wd.rt.plots, paste0("NRFD_", paste0(BASE, "\u2212NL"), "_", method, ".d.rt.log2s_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_", genes[g], "_6x6"))
   plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, end, start, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=6, kb, F, genes[g])
}
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr,  55869228, 59869228, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb, gene="MARS")
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr,  41025082, 45025082, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb, gene="KIF18B")
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr,  46877887, 50877887, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb, gene="RB1")
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr,  43003675, 47003675, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb, gene="B2M")
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 183308867, 187395734, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb, gene="IRF2")
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 0, 3295184, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb, gene="TERT")
...
file.name <- file.path(wd.rt.plots, paste0("NRFD_", base, "_", method, ".d.rt.log2s_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_TTR_TOR1AIP1"))
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 174851177, 184851177, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 143701718, 147701718, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 141701718, 149701718, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 64617867, 65617867, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr,  30889611, 34889611, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
...
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 350406,	1392939, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 0,	1892939, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 0,	2892939, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
plotBootstrapRFD(file.name, paste0(BASE, "\u2212NL"), chr, 0,	3892939, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
...
main.text <- c("SCLC-NL vs. SCLC", "Total")
plotBootstrapSummary(summary.sclc.nl.vs.sclc, file.name, main.text)
plotBootstrapSummaryTotal(summary.sclc.nl.vs.sclc, file.name, main.text)

file.name <- file.path(wd.rt.plots, "barchart_SCLC-NL-vs-NB")
main.text <- c("SCLC-NL vs. NB", "Total")
plotBootstrapSummary(summary.sclc.nl.vs.nbl, file.name, main.text)
plotBootstrapSummaryTotal(summary.sclc.nl.vs.nbl, file.name, main.text)

file.name <- file.path(wd.rt.plots, "barchart_SCLC-NL-vs-CLL")
main.text <- c("SCLC-NL vs. CLL", "Total")
plotBootstrapSummary(summary.sclc.nl.vs.cll, file.name, main.text)
plotBootstrapSummaryTotal(summary.sclc.nl.vs.cll, file.name, main.text)
...
report.nbl.cl.vs.sclc <- getBootstrapReport(rfd, nrds.RT.NRFD.nbl.cl, nrds.RT.NRFD.sclc, "NB-CL", "SCLC")
writeTable(report.nbl.cl.vs.sclc, file.path(wd.rt.data, paste0("NRFD_NB-CL_vs_SCLC_20KB.txt")), colnames=T, rownames=F, sep="\t")

report.nbl.cl.vs.sclc.nl <- getBootstrapReport(rfd, nrds.RT.NRFD.nbl.cl, nrds.RT.NRFD.sclc.nl, "NB-CL", "SCLC-NL")
writeTable(report.nbl.cl.vs.sclc.nl, file.path(wd.rt.data, paste0("NRFD_NB-CL_vs_SCLC-NL_20KB.txt")), colnames=T, rownames=F, sep="\t")

report.nbl.cl.vs.nbl  <- getBootstrapReport(rfd, nrds.RT.NRFD.nbl.cl, nrds.RT.NRFD.nbl, "NB-CL", "NBL")
writeTable(report.nbl.cl.vs.nbl, file.path(wd.rt.data, paste0("NRFD_NB-CL_vs_NB_20KB.txt")), colnames=T, rownames=F, sep="\t")

report.nbl.cl.vs.cll  <- getBootstrapReport(rfd, nrds.RT.NRFD.nbl.cl, nrds.RT.NRFD.cll, "NB-CL", "CLL")
writeTable(report.nbl.cl.vs.cll, file.path(wd.rt.data, paste0("NRFD_NB-CL_vs_CLL_20KB.txt")), colnames=T, rownames=F, sep="\t")

report.nbl.cl.vs.lcl  <- getBootstrapReport(rfd, nrds.RT.NRFD.nbl.cl, nrds.RT.NRFD.lcl, "NB-CL", "LCL")
writeTable(report.nbl.cl.vs.lcl, file.path(wd.rt.data, paste0("NRFD_NB-CL_vs_LCL_20KB.txt")), colnames=T, rownames=F, sep="\t")
...
##
file.name <- file.path(wd.rt.plots, "barchart_SF7_NB-CL-vs-SCLC")
main.text <- c("NB-CL vs. SCLC replication domains", "")
plotBootstrapSummary(summary.nbl.cl.vs.sclc, file.name, main.text)
plotBootstrapSummaryTotal(summary.nbl.cl.vs.sclc, file.name, "NB-CL vs. SCLC")

file.name <- file.path(wd.rt.plots, "barchart_SF7_NB-CL-vs-SCLC-NL")
main.text <- c("NB-CL vs. SCLC-NL replication domains", "")
plotBootstrapSummary(summary.nbl.cl.vs.sclc.nl, file.name, main.text)
plotBootstrapSummaryTotal(summary.nbl.cl.vs.sclc.nl, file.name, "NB-CL vs. SCLC-NL")

file.name <- file.path(wd.rt.plots, "barchart_SF7_NB-CL-vs-NB")
main.text <- c("NB-CL vs. NB replication domains", "")
plotBootstrapSummary(summary.nbl.cl.vs.nbl, file.name, main.text)
plotBootstrapSummaryTotal(summary.nbl.cl.vs.nbl, file.name, "NB-CL vs. NB")

file.name <- file.path(wd.rt.plots, "barchart_SF7_NB-CL-vs-CLL")
main.text <- c("NB-CL vs. CLL replication domains", "")
plotBootstrapSummary(summary.nbl.cl.vs.cll, file.name, main.text)
plotBootstrapSummaryTotal(summary.nbl.cl.vs.cll, file.name, "NB-CL vs. CLL")

file.name <- file.path(wd.rt.plots, "barchart_SF7_NB-CL-vs-LCL")
main.text <- c("NB-CL vs. LCL replication domains", "")
plotBootstrapSummary(summary.nbl.cl.vs.lcl, file.name, main.text)
plotBootstrapSummaryTotal(summary.nbl.cl.vs.lcl, file.name, "NB-CL vs. LCL")
...
plotReportEGDensity <- function(report.rfds, names, file.name, main.text) {
   ...
   ##
   pdf(file.name, height=6, width=6.2)
   ...
   plot(NULL, xlim=c(0.5, 9.1), ylim=c(15, 18), ylab="", main=main.text, col=cols[1], xaxt="n", yaxt="n", bty="n", pch=rfds$pch, cex.axis=1.7, cex.lab=1.8, cex.main=1.9)
   ...
   text(8, rfds$CTR_IZ[n], "      IZ ", cex=1.8, col=red, font=2)
   for (n in 2:length(names))
      text(rfds$X[n], rfds$CTR_IZ[n], rfds$CTR_IZ[n], col=cols[2], pos=rfds$pos2[n], cex=1.8)
   ...
   ##
   par(mar=c(5,3.6,0,0))
   plot(NULL, xlim=c(0.5, 9.1), ylim=c(9.8, 12.7), ylab="", xlab="", col=cols[2], xaxt="n", yaxt="n", bty="n", pch=rfds$pch, cex.axis=1.7, cex.lab=1.8, cex.main=1.9)
   ...
   text(8, rfds$TTR[n], "   TTR ", cex=1.8, col="black", pos=3, font=2) 
   text(8, rfds$CTR_TZ[n], "     TZ ", cex=1.8, col=blue, pos=1, font=2)
   for (n in 2:length(names)) {
      text(rfds$X[n], rfds$TTR[n], rfds$TTR[n],    col=cols[1], pos=rfds$pos1[n], cex=1.8)
      text(rfds$X[n], rfds$CTR_TZ[n],  rfds$CTR_TZ[n], col=cols[3], pos=rfds$pos3[n], cex=1.8)
   }

   ##
   axis(side=2, at=seq(10, 12, by=1), labels=c(10, 11, 12), cex.axis=1.7)
   axis(side=1, at=seq(3, 7, by=2), labels=names[2:4], cex.axis=1.7)
   #axis(side=1, at=seq(3, 7, by=2), labels=c("n=70", "n=53", "n=71"), line=1.2, col=NA, cex.axis=1.25)

   mtext("                      Number", side=2, line=2.6, cex=1.8)
   dev.off()
}
...
report.rfds <- list(as.numeric(report[1, -1]), as.numeric(report[2, -1]), as.numeric(report[3, -1]), as.numeric(report[4, -1]))
file.name <- file.path(wd.rt.plots, paste0("RFD_EG_D_N_Mb_BIGGER_tumor_6x6.pdf"))
...
nrds.RT.RFD.sclc.tn <- nrds.RT.RFD
# > nrow(nrds.RT.RFD.sclc.tn)
# [1] 2651861
...
# -----------------------------------------------------------------------------
# |RFD| ≥ 0.9
# Last Modified: 27/10/19; 24/09/19
# -----------------------------------------------------------------------------
boundary.upper <- 950   ## RFD > +0.9
boundary.lower <-  50   ## RFD < -0.9

nrds.RT.RFD.sclc.tn.t <- getBootstrapTTR(nrds.RT.RFD.sclc.tn, boundary.lower, boundary.upper)
nrds.RT.RFD.nbl.wb.t  <- getBootstrapTTR(nrds.RT.RFD.nbl.wb,  boundary.lower, boundary.upper)
nrds.RT.RFD.cll.wb.t  <- getBootstrapTTR(nrds.RT.RFD.cll.wb,  boundary.lower, boundary.upper)
nrow(nrds.RT.RFD.sclc.tn.t)
# [1] 2329222
# > 2329222/2651861
# [1] 0.8783349
nrow(nrds.RT.RFD.nbl.wb.t)
# [1] 1235100
# > 1235100/2651759
# [1] 0.4657663
nrow(nrds.RT.RFD.cll.wb.t)
# [1] 1940738
# > 1940738/2647228
# [1] 0.7331208

overlaps.t <- intersect(rownames(nrds.RT.RFD.sclc.tn.t), rownames(nrds.RT.RFD.cll.wb.t))
length(overlaps.t)
# [1] 1821067
...
# -----------------------------------------------------------------------------
# ALL TTR
# Last Modified: 27/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.t <- intersect(intersect(rownames(nrds.RT.RFD.sclc.t), rownames(nrds.RT.RFD.cll.t)), rownames(nrds.RT.RFD.lcl.t))
length(overlaps.t)
# [1] 1203540

nrds.sclc.RT.o <- nrds.RT.RFD.sclc.t[overlaps.t,]
nrds.cll.RT.o <- nrds.RT.RFD.cll.t[overlaps.t,]
nrds.lcl.RT.o <- nrds.RT.RFD.lcl.t[overlaps.t,]
...
# -----------------------------------------------------------------------------
# ALL TTR (between T and TN)
# Last Modified: 27/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.t <- intersect(rownames(nrds.RT.RFD.sclc.t), rownames(nrds.RT.RFD.sclc.tn.t))
length(overlaps.t)
# [1] 2057751

nrds.sclc.RT.o    <- nrds.RT.RFD.sclc.t[overlaps.t,]
nrds.sclc.tn.RT.o <- nrds.RT.RFD.sclc.tn.t[overlaps.t,]
...
nrds.RT.RFD.sclc.tn.c <- getBootstrapCTR(nrds.RT.RFD.sclc.tn, boundary.lower, boundary.upper)
nrds.RT.RFD.cll.wb.c  <- getBootstrapCTR(nrds.RT.RFD.cll.wb,  boundary.lower, boundary.upper)
nrow(nrds.RT.RFD.sclc.tn.c)
# [1] 322639
nrow(nrds.RT.RFD.cll.wb.c)
# [1] 706490

nrds.RT.RFD.sclc.tn.c.e <- subset(nrds.RT.RFD.sclc.tn.c, SPLINE >= 0)
nrds.RT.RFD.sclc.tn.c.l <- subset(nrds.RT.RFD.sclc.tn.c, SPLINE < 0)
nrow(nrds.RT.RFD.sclc.tn.c.e)
# [1] 197549
nrow(nrds.RT.RFD.sclc.tn.c.l)
# [1] 125090

nrds.RT.RFD.cll.wb.c.e <- subset(nrds.RT.RFD.cll.wb.c, SPLINE >= 0)
nrds.RT.RFD.cll.wb.c.l <- subset(nrds.RT.RFD.cll.wb.c, SPLINE < 0)
nrow(nrds.RT.RFD.cll.wb.c.e)
# [1] 296428
nrow(nrds.RT.RFD.cll.wb.c.l)
# [1] 410062
...
# Last Modified: 19/10/19
# -----------------------------------------------------------------------------
overlaps.c.e <- intersect(rownames(nrds.RT.RFD.sclc.c.e), rownames(nrds.RT.RFD.cll.c.e))
length(overlaps.c.e)
# [1] 113786

nrds.sclc.RT.o <- nrds.RT.RFD.sclc.c.e[overlaps.c.e,]
...
# -----------------------------------------------------------------------------
# CTR (E) (between T and TN)
# Last Modified: 27/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.c.e <- intersect(rownames(nrds.RT.RFD.sclc.c.e), rownames(nrds.RT.RFD.sclc.tn.c.e))
length(overlaps.c.e)
# [1] 139592

nrds.sclc.RT.o    <- nrds.RT.RFD.sclc.c.e[overlaps.c.e,]
nrds.sclc.tn.RT.o <- nrds.RT.RFD.sclc.tn.c.e[overlaps.c.e,]
...
# Last Modified: 19/10/19
# -----------------------------------------------------------------------------
overlaps.c.l <- intersect(rownames(nrds.RT.RFD.sclc.c.l), rownames(nrds.RT.RFD.cll.c.l))
length(overlaps.c.l)
# [1] 71202

nrds.sclc.RT.o <- nrds.RT.RFD.sclc.c.l[overlaps.c.l,]
...
# -----------------------------------------------------------------------------
# CTR (L) (between T and TN)
# Last Modified: 27/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.c.l <- intersect(rownames(nrds.RT.RFD.sclc.c.l), rownames(nrds.RT.RFD.sclc.tn.c.l))
length(overlaps.c.l)
# [1] 92507

nrds.sclc.RT.o    <- nrds.RT.RFD.sclc.c.l[overlaps.c.l,]
nrds.sclc.tn.RT.o <- nrds.RT.RFD.sclc.tn.c.l[overlaps.c.l,]
