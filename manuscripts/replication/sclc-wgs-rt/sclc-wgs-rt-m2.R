...
file.name <- file.path(wd.rt.plots, "SPR-MRTR_SCLC-S-G1_spline_spearman")
...
file.name <- file.path(wd.rt.plots, "MRTR_SCLC-M2-M1_spline_spearman")
...
file.name <- file.path(wd.rt.plots, "MRTR-RDC_SCLC-M2-M1_spline_spearman")
...
file.name <- file.path(wd.rt.plots, "MRTR-Woodfine_SCLC-M2-M1_spline_spearman")
