...
report.brca.us.vs.brca.uk <- getBootstrapReport(rfd, nrds.RT.NRFD.brca.us, nrds.RT.NRFD.brca.uk, "BRCA-US", "BRCA-UK")
writeTable(report.brca.us.vs.brca.uk, file.path(wd.rt.data, paste0("NRFD_BRCA-US_vs_BRCA-UK_20K.txt")), colnames=T, rownames=F, sep="\t")

report.brca.us.vs.brca.eu <- getBootstrapReport(rfd, nrds.RT.NRFD.brca.us, nrds.RT.NRFD.brca.eu, "BRCA-US", "BRCA-EU")
writeTable(report.brca.us.vs.brca.eu, file.path(wd.rt.data, paste0("NRFD_BRCA-US_vs_BRCA-EU_20K.txt")), colnames=T, rownames=F, sep="\t")
...
report.sclc.nl.vs.nbl  <- readTable(file.path(wd.rt.data, paste0("NRFD_BRCA-US_vs_ESAD-UK_20K.txt")), header=T, rownames=F, sep="")
report.sclc.nl.vs.cll  <- readTable(file.path(wd.rt.data, paste0("NRFD_BRCA-US_vs_CLLE-ES_20K.txt")), header=T, rownames=F, sep="")
report.sclc.nl.vs.luad <- readTable(file.path(wd.rt.data, paste0("NRFD_BRCA-US_vs_LUAD-US_20K.txt")), header=T, rownames=F, sep="")
report.sclc.nl.vs.brca <- readTable(file.path(wd.rt.data, paste0("NRFD_BRCA-US_vs_BRCA-EU_20K.txt")), header=T, rownames=F, sep="")
...
main.text <- c("BRCA-US vs. BRCA-UK replication domains", "")
...
file.name <- file.path(wd.rt.plots, "barchart_BRCA-US_vs_ESAD-UK")
main.text <- c("BRCA-US vs. ESAD-UK replication domains", "")
plotBootstrapSummary(summary.sclc.nl.vs.nbl, file.name, main.text)
plotBootstrapSummaryTotal(summary.sclc.nl.vs.nbl, file.name, "BRCA-US vs. ESAD-UK")

file.name <- file.path(wd.rt.plots, "barchart_BRCA-US_vs_CLLE-ES")
main.text <- c("BRCA-US vs. CLLE-ES replication domains", "")
plotBootstrapSummary(summary.sclc.nl.vs.cll, file.name, main.text)
plotBootstrapSummaryTotal(summary.sclc.nl.vs.cll, file.name, "BRCA-US vs. CLLE-ES")

file.name <- file.path(wd.rt.plots, "barchart_BRCA-US_vs_LUAD-US")
main.text <- c("BRCA-US vs. LUAD-US replication domains", "")
plotBootstrapSummary(summary.sclc.nl.vs.luad, file.name, main.text)
plotBootstrapSummaryTotal(summary.sclc.nl.vs.luad, file.name, "BRCA-US vs. LUAD-US")

file.name <- file.path(wd.rt.plots, "barchart_BRCA-US_vs_BRCA-EU")
main.text <- c("BRCA-US vs. BRCA-EU replication domains", "")
plotBootstrapSummary(summary.sclc.nl.vs.brca, file.name, main.text)
plotBootstrapSummaryTotal(summary.sclc.nl.vs.brca, file.name, "BRCA-US vs. BRCA-EU")
...
plotBootstrapRFD(file.name, BASE, chr, 0, 249239581, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=10, kb)
...
plotBootstrapRFD(file.name, BASE, chr,  70000000,  80000000, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
plotBootstrapRFD(file.name, BASE, chr,  65000000,  85000000, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
plotBootstrapRFD(file.name, BASE, chr,  95500000, 105000000, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
plotBootstrapRFD(file.name, BASE, chr, 160000000, 170000000, nrds.RT.NRFD, bed.gc.chr, boundary.upper, boundary.lower, "png", width=5, kb)
...
# -----------------------------------------------------------------------------
nrds.RT.NRFD.cll.ttr <- getBootstrapTTR(nrds.RT.NRFD.cll, 0.9)

nrds.RT.NRFD.cll.ttr.e <- subset(nrds.RT.NRFD.cll.ttr, RT > 0)
nrds.RT.NRFD.cll.ttr.l <- subset(nrds.RT.NRFD.cll.ttr, RT < 0)

nrds.RT.NRFD.cll.ctr <- getBootstrapCTR(nrds.RT.NRFD.cll, 0.9)
nrds.RT.NRFD.cll.ctr.iz <- subset(nrds.RT.NRFD.cll.ctr, NRFD > 0)
nrds.RT.NRFD.cll.ctr.tz <- subset(nrds.RT.NRFD.cll.ctr, NRFD < 0)

nrds.RT.NRFD.cll.ctr.iz.e <- subset(nrds.RT.NRFD.cll.ctr.iz, RT > 0)
nrds.RT.NRFD.cll.ctr.iz.l <- subset(nrds.RT.NRFD.cll.ctr.iz, RT < 0)
nrds.RT.NRFD.cll.ctr.tz.e <- subset(nrds.RT.NRFD.cll.ctr.tz, RT > 0)
nrds.RT.NRFD.cll.ctr.tz.l <- subset(nrds.RT.NRFD.cll.ctr.tz, RT < 0)

nrow(nrds.RT.NRFD.cll.ctr.iz.e)/nrow(nrds.RT.NRFD.cll)
# [1] 0.06612303
nrow(nrds.RT.NRFD.cll.ctr.iz.l)/nrow(nrds.RT.NRFD.cll)
# [1] 0.05293223
nrow(nrds.RT.NRFD.cll.ctr.tz.e)/nrow(nrds.RT.NRFD.cll)
# [1] 0.04680801
nrow(nrds.RT.NRFD.cll.ctr.tz.l)/nrow(nrds.RT.NRFD.cll)
# [1] 0.07899089
