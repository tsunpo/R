...
report.esad.uk.vs.brca.uk <- getBootstrapReport(rfd, nrds.RT.NRFD.esad.uk, nrds.RT.NRFD.brca.uk, "ESAD-UK", "BRCA-UK")
writeTable(report.esad.uk.vs.brca.uk, file.path(wd.rt.data, paste0("NRFD_ESAD-UK_vs_BRCA-UK_20K.txt")), colnames=T, rownames=F, sep="\t")

report.brca.uk.vs.esad.uk <- getBootstrapReport(rfd, nrds.RT.NRFD.brca.uk, nrds.RT.NRFD.esad.uk, "BRCA-UK", "ESAD-UK")
writeTable(report.brca.uk.vs.esad.uk, file.path(wd.rt.data, paste0("NRFD_BRCA-UK_vs_ESAD-UK_20K.txt")), colnames=T, rownames=F, sep="\t")

report.brca.us.vs.esad.uk <- getBootstrapReport(rfd, nrds.RT.NRFD.brca.us, nrds.RT.NRFD.esad.uk, "BRCA-US", "ESAD-UK")
writeTable(report.brca.us.vs.esad.uk, file.path(wd.rt.data, paste0("NRFD_BRCA-US_vs_ESAD-UK_20K.txt")), colnames=T, rownames=F, sep="\t")
