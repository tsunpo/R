...
samples1 <- readTable(file.path(wd.ngs, "ov-us_wgs_m2_n42.txt"), header=T, rownames=T, sep="")   ## M2/M1
#samples1 <- readTable(file.path(wd.ngs, ""), header=T, rownames=T, sep="")                      ## Q4/Q1
samples1 <- subset(samples1, M2 == 2)[,1]
samples0 <- readTable(file.path(wd.ngs, "ov-us_wgs_m2_n42.txt"), header=T, rownames=T, sep="")
