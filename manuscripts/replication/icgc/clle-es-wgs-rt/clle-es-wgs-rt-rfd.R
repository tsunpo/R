...
report.clle.es.vs.brca.uk <- getBootstrapReport(rfd, nrds.RT.NRFD.clle.es, nrds.RT.NRFD.brca.uk, "CLLE-ES", "BRCA-UK")
writeTable(report.clle.es.vs.brca.uk, file.path(wd.rt.data, paste0("NRFD_CLLE-ES_vs_BRCA-UK_20K.txt")), colnames=T, rownames=F, sep="\t")

report.brca.uk.vs.clle.es <- getBootstrapReport(rfd, nrds.RT.NRFD.brca.uk, nrds.RT.NRFD.clle.es, "BRCA-UK", "CLLE-ES")
writeTable(report.brca.uk.vs.clle.es, file.path(wd.rt.data, paste0("NRFD_BRCA-UK_vs_CLLE-ES_20K.txt")), colnames=T, rownames=F, sep="\t")
