...
nrds.RT.NRFD.luad <- nrds.RT.NRFD
nrow(nrds.RT.NRFD.luad)
# [1] 2664256

#snr$S[3] <- sd(nrds.RT.NRFD.luad$SPLINE)
#snr$N[3] <- sd(nrds.RT.NRFD.luad$RT - nrds.RT.NRFD.nbl$SPLINE)
...
file.name <- file.path(wd.rt.plots, paste0("NRFD_", BASE, "_", method, ".d.rt.log2s_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_TTR_RFD=0_nasa.blue_google.red_orange_cex=0.5_pch=19"))
...
report.luad.vs.sclc.nl <- getBootstrapReport(rfd, nrds.RT.NRFD.luad, nrds.RT.NRFD.sclc.nl, "LUAD", "SCLC-NL")
writeTable(report.luad.vs.sclc.nl, file.path(wd.rt.data, paste0("NRFD_LUAD_vs_SCLC-NL_20KB.txt")), colnames=T, rownames=F, sep="\t")

report.luad.vs.sclc <- getBootstrapReport(rfd, nrds.RT.NRFD.luad, nrds.RT.NRFD.sclc, "LUAD", "SCLC")
writeTable(report.luad.vs.sclc, file.path(wd.rt.data, paste0("NRFD_LUAD_vs_SCLC_20KB.txt")), colnames=T, rownames=F, sep="\t")

report.luad.vs.nbl  <- getBootstrapReport(rfd, nrds.RT.NRFD.luad, nrds.RT.NRFD.nbl, "LUAD", "NBL")
writeTable(report.luad.vs.nbl, file.path(wd.rt.data, paste0("NRFD_LUAD_vs_NBL_20KB.txt")), colnames=T, rownames=F, sep="\t")

report.luad.vs.cll  <- getBootstrapReport(rfd, nrds.RT.NRFD.luad, nrds.RT.NRFD.cll, "LUAD", "CLL")
writeTable(report.luad.vs.cll, file.path(wd.rt.data, paste0("NRFD_LUAD_vs_CLL_20KB.txt")), colnames=T, rownames=F, sep="\t")

# -----------------------------------------------------------------------------
# Plot report (between NL, Ts)
# Last Modified: 27/11/19
# -----------------------------------------------------------------------------
save(report.luad.vs.sclc.nl, report.luad.vs.sclc, report.luad.vs.nbl, report.luad.vs.cll, file=file.path(wd.rt.data, paste0("NRFD_ALL_20KB.RData")))
...
# -----------------------------------------------------------------------------
summary.luad.vs.sclc.nl <- getBootstrapSummary(report.luad.vs.sclc.nl)
summary.luad.vs.sclc    <- getBootstrapSummary(report.luad.vs.sclc)
summary.luad.vs.nbl     <- getBootstrapSummary(report.luad.vs.nbl)
summary.luad.vs.cll     <- getBootstrapSummary(report.luad.vs.cll)

##
file.name <- file.path(wd.rt.plots, "F7_LUAD-vs-SCLC-NL_barchart_dhl.yellow_basf.green_pt.cex=2.5")
main.text <- c("LUAD vs. SCLC-NL replication-domain landscape", "")
plotBootstrapSummary(summary.luad.vs.sclc.nl, file.name, main.text)
plotBootstrapSummaryTotal(summary.luad.vs.sclc.nl, file.name, "LUAD vs. SCLC-NL")

file.name <- file.path(wd.rt.plots, "F7_LUAD-vs-SCLC_barchart_dhl.yellow_basf.green_pt.cex=2.5")
main.text <- c("LUAD vs. SCLC replication-domain landscape", "")
plotBootstrapSummary(summary.luad.vs.sclc, file.name, main.text)
plotBootstrapSummaryTotal(summary.luad.vs.sclc, file.name, "LUAD vs. SCLC")

file.name <- file.path(wd.rt.plots, "F7_LUAD-vs-NBL_barchart_dhl.yellow_basf.green_pt.cex=2.5")
main.text <- c("LUAD vs. NBL replication-domain landscape", "")
plotBootstrapSummary(summary.luad.vs.nbl, file.name, main.text)
plotBootstrapSummaryTotal(summary.luad.vs.nbl, file.name, "LUAD vs. NBL")

file.name <- file.path(wd.rt.plots, "F7_LUAD-vs-CLL_barchart_dhl.yellow_basf.green_pt.cex=2.5")
main.text <- c("LUAD vs. CLL replication-domain landscape", "")
plotBootstrapSummary(summary.luad.vs.cll, file.name, main.text)
plotBootstrapSummaryTotal(summary.luad.vs.cll, file.name, "LUAD vs. CLL")
...
# -----------------------------------------------------------------------------
nrds.RT.NRFD.luad.ttr <- getBootstrapTTR(nrds.RT.NRFD.luad, 0.9)

nrds.RT.NRFD.luad.ctr <- getBootstrapCTR(nrds.RT.NRFD.luad, 0.9)
nrds.RT.NRFD.luad.ctr.iz <- subset(nrds.RT.NRFD.luad.ctr, NRFD > 0)
nrds.RT.NRFD.luad.ctr.tz <- subset(nrds.RT.NRFD.luad.ctr, NRFD < 0)

nrds.RT.NRFD.luad.ctr.iz.e <- subset(nrds.RT.NRFD.luad.ctr.iz, RT > 0)
nrds.RT.NRFD.luad.ctr.iz.l <- subset(nrds.RT.NRFD.luad.ctr.iz, RT < 0)
nrds.RT.NRFD.luad.ctr.tz.e <- subset(nrds.RT.NRFD.luad.ctr.tz, RT > 0)
nrds.RT.NRFD.luad.ctr.tz.l <- subset(nrds.RT.NRFD.luad.ctr.tz, RT < 0)

nrow(nrds.RT.NRFD.luad.ctr.iz.e)/nrow(nrds.RT.NRFD.luad)
# [1] 0.07562017d
nrow(nrds.RT.NRFD.luad.ctr.iz.l)/nrow(nrds.RT.NRFD.luad)
# [1] 0.04072021
nrow(nrds.RT.NRFD.luad.ctr.tz.e)/nrow(nrds.RT.NRFD.luad)
# [1] 0.0571664
nrow(nrds.RT.NRFD.luad.ctr.tz.l)/nrow(nrds.RT.NRFD.luad)
# [1] 0.05736848
