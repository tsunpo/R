...
# -----------------------------------------------------------------------------
nrds <- getLog2ScaledRT(wd.rt.data, base, method, "T", "N", n1, n0, chrs, bed.gc)
save(nrds, file=file.path(wd.rt.data, paste0(base, "_", method, ".gc.cn.m.rt.log2s_", "s-g1_peiflyne_wes_new", ".RData")))
...
load(file.path(wd.rt.data, paste0("lcl", "_", "rpkm", ".gc.cn.m.rt.log2s_", "s-g1", ".RData")))
nrds.lcl <- nrds
...
for (c in 2:2) {
   ...
   file.name <- file.path(wd.rt.plots, paste0("RT_", BASE, "_", method, ".d.rt.log2s_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_SPLINE"))   
