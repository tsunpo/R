...
main.text <- c("NBL T (n=56) vs. LCL S/G1", "Chromosomal median (CM2/CM1)")
ymin <- -0.8732989
ymax <- 0.8643419
...
plotPCA(1, 2, pca.de, trait, wd.rt.plots, "pca_nbl_T_chrs_spline_spearman", size=6, file.main, "topleft", c("red", "lightcoral", "skyblue3", "blue"), NULL, flip.x=1, flip.y=1, legend.title="Overall corr. with LCL S/G1")
