...
plotPCA(1, 2, pca.de, trait, wd.rt.plots, "PCA_NBL_nasa.blue_google.red_lighter.50_pch=19_pt.cex=2.5_pch=19_2314", size=6, file.main, "bottomright", c(red, red.lighter, blue.lighter, blue), NULL, flip.x=1, flip.y=1, legend.title=NA)
