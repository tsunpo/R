...
plotPCA(1, 2, pca.de, trait, wd.rt.plots, "pca_NBL_chrs_spline_spearman", size=6, file.main, "topleft", c("red", "lightcoral", "skyblue3", "blue"), NULL, flip.x=1, flip.y=1, legend.title=NA)
