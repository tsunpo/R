...
main.text <- c("NBL read depth vs. LCL RT", "")
ymin <- -0.8773492
ymax <- 0.8392611
...
plotPCA(1, 2, pca.de, trait, wd.rt.plots, "PCA_NBL_chrs", size=6, file.main, "bottomright", c("red", "lightpink1", "lightskyblue2", "blue"), NULL, flip.x=1, flip.y=1, legend.title=NA)
