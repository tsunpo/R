...
wd.rt    <- file.path(wd.anlys, "replication", paste0(base, "-wgs-rt-normal15"))
...
load(file.path(wd.anlys, "replication", paste0(base, "-wgs-rt-normal15"), "data", paste0(base, "_", method, ".gc.cn.d.rt.log2s_", "m2-m1", ".RData")))
...
nrds.RT.RFD.nbl.ct <- nrds.RT.RFD
# > nrow(nrds.RT.RFD.nbl.ct)
# [1] 2651759
...
nrds.RT.RFD.nbl.ct.t <- getBootstrapTTR(nrds.RT.RFD.nbl.ct,  boundary.lower, boundary.upper)
...
# -----------------------------------------------------------------------------
# ALL TTR (between NBL and NBL-CTC)
# Last Modified: 02/11/19; 31/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.t <- intersect(rownames(nrds.RT.RFD.nbl.t), rownames(nrds.RT.RFD.nbl.ct.t))
length(overlaps.t)
# [1] 1582128

nrds.nbl.RT.o    <- nrds.RT.RFD.nbl.t[overlaps.t,]
nrds.nbl.ct.RT.o <- nrds.RT.RFD.nbl.ct.t[overlaps.t,]

##
nrds.nbl.RT.o$SIGN <- nrds.nbl.RT.o$SLOPE * nrds.nbl.ct.RT.o$SLOPE
length(which(nrds.nbl.RT.o$SIGN > 0))
# [1] 1579584

# -----------------------------------------------------------------------------
# ALL TTR (between NBL and NBL-CL)
# Last Modified: 02/11/19; 31/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.t <- intersect(rownames(nrds.RT.RFD.nbl.t), rownames(nrds.RT.RFD.nbl.cl.t))
length(overlaps.t)
# [1] 1340057
...
##
nrds.nbl.RT.o$SIGN <- nrds.nbl.RT.o$SLOPE * nrds.nbl.cl.RT.o$SLOPE
length(which(nrds.nbl.RT.o$SIGN > 0))
# [1] 1259460
...
nrds.RT.RFD.nbl.ct.c <- getBootstrapCTR(nrds.RT.RFD.nbl.ct,  boundary.lower, boundary.upper)
nrds.RT.RFD.nbl.cl.c <- getBootstrapCTR(nrds.RT.RFD.nbl.cl,  boundary.lower, boundary.upper)
nrow(nrds.RT.RFD.nbl.c)
# [1] 613152
nrow(nrds.RT.RFD.nbl.ct.c)
# [1] 848215
...
nrds.RT.RFD.nbl.ct.c.e <- subset(nrds.RT.RFD.nbl.ct.c, SPLINE >= 0)
nrds.RT.RFD.nbl.ct.c.l <- subset(nrds.RT.RFD.nbl.ct.c, SPLINE < 0)
nrow(nrds.RT.RFD.nbl.ct.c.e)
# [1] 380134
nrow(nrds.RT.RFD.nbl.ct.c.l)
# [1] 468081
...
# -----------------------------------------------------------------------------
# CTR (E) (between NBL and NBL-CTC)
# Last Modified: 02/11/19; 31/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.c.e <- intersect(rownames(nrds.RT.RFD.nbl.c.e), rownames(nrds.RT.RFD.nbl.ct.c.e))
length(overlaps.c.e)
# [1] 174324

nrds.nbl.RT.o    <- nrds.RT.RFD.nbl.c.e[overlaps.c.e,]
nrds.nbl.ct.RT.o <- nrds.RT.RFD.nbl.ct.c.e[overlaps.c.e,]
...
# -----------------------------------------------------------------------------
# CTR (E) (between NBL and NBL-CL)
# Last Modified: 02/11/19; 31/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.c.e <- intersect(rownames(nrds.RT.RFD.nbl.c.e), rownames(nrds.RT.RFD.nbl.cl.c.e))
length(overlaps.c.e)
# [1] 149333
...
# -----------------------------------------------------------------------------
# CTR (L) (between NBL and NBL-CTC)
# Last Modified: 02/11/19; 31/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.c.l <- intersect(rownames(nrds.RT.RFD.nbl.c.l), rownames(nrds.RT.RFD.nbl.ct.c.l))
length(overlaps.c.l)
# [1] 186774

nrds.nbl.RT.o    <- nrds.RT.RFD.nbl.c.l[overlaps.c.l,]
nrds.nbl.ct.RT.o <- nrds.RT.RFD.nbl.ct.c.l[overlaps.c.l,]
...
# Last Modified: 02/11/19; 31/10/19; 22/09/19
# -----------------------------------------------------------------------------
overlaps.c.l <- intersect(rownames(nrds.RT.RFD.nbl.c.l), rownames(nrds.RT.RFD.nbl.cl.c.l))
length(overlaps.c.l)
# [1] 124952
