...
samples.125 <- readTable(file.path(wd.ngs, "nbl_wes.list"), header=F, rownames=F, sep="")
overlaps1 <- intersect(samples.56, samples.125)
length(overlaps1)
# [1] 3

samples.22 <- readTable(file.path(wd.ngs, "WES_INFORM.list"), header=F, rownames=F, sep="")
