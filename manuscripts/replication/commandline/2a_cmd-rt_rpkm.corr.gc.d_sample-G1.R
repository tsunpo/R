...
for (c in 1:22) {
   ...
   rpkms.chr.rt.lcl.RT <- setSpline(rpkms.chr.rt.lcl, bed.gc.chr, "N")   ## ADD 05/06/19; LCL G1
...
save(cor, cors, file=file.path(wd1.rt.data, "samples", paste0("rd-vs-g1_", SAMPLE, "-vs-lcl_spline_spearman.RData")))
