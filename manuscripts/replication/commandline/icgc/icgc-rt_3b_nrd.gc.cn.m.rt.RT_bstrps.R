...
load(file.path(wd.rt.data, 1, paste0(base, "_", method, ".gc.cn.m.rt.RT.RData")))
nrds.RT.BSTRPS <- getBSTRPS(nrds.RT, COLUMN, 1)
for (b in 2:BSTRPS) {
   load(file.path(wd.rt.data, b, paste0(base, "_", method, ".gc.cn.m.rt.RT.RData")))
