...
nrds.chr <- nrds
save(nrds.chr, file=file.path(wd, paste0("LCL/analysis/replication/lcl-wgs-rt/data/lcl_rpkm.gc.cn.d.rt.log2s_s-g1_peiflyne_wes_new_", chr, ".RData")))

###
##
#load(file=file.path(wd, paste0("LCL/analysis/replication/lcl-wgs-rt/data/lcl_rpkm.gc.cn.d.rt.log2s_s-g1_peiflyne_wes_chr1.RData")))
#nrds <- nrds.chr
#for (c in 2:22) {
#   chr <- chrs[c]
#   load(file=file.path(wd, paste0("LCL/analysis/replication/lcl-wgs-rt/data/lcl_rpkm.gc.cn.d.rt.log2s_s-g1_peiflyne_wes_", chr, ".RData")))
#   
#   nrds <- rbind(nrds, nrds.chr)
#}
#save(nrds, file=file.path(wd, paste0("LCL/analysis/replication/lcl-wgs-rt/data/lcl_rpkm.gc.cn.d.rt.log2s_s-g1_peiflyne_wes.RData")))
