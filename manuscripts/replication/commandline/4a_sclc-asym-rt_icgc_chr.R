...
load(file=file.path(wd.asym.data, paste0(icgc, "_mut_snvs.RData")))
...
#for (c in 1:22) {
   ...
   save(snvs.chr, file=file.path(wd.asym.data, paste0(icgc, "_mut_snvs_chr", CHR,".RData")))
...
#}
save(muts.chr, file=file.path(wd.asym.data, paste0(icgc, "_mut_snvs_s6_chr", CHR,".RData")))
