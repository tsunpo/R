...
#for (c in 1:22) {
   ...
   nrds.chr <- toTable(NA, 3, nrow(nrds.chr.m), c("T", "N", "RATIO"))
   ...
   writeTable(outputRT(nrds.chr), gzfile(file.path(wd.rt.data, paste0(base, "_", method, ".gc.cn.m.ratio_", chr, "_", PAIR, "-", PAIR, "_n", n1, "-", n0, ".txt.gz"))), colnames=T, rownames=F, sep="\t")
#}
