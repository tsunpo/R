...
writeTable(samples.cll, file.path(wd.ngs, "cll_wgs_n96_N.txt"), colnames=T, rownames=F, sep="\t")
#         0%        25%        50%        75%       100% 
...
plotPCA(1, 2, pca.de, trait, wd.rt.plots, "PCA_CLL-WB_chrs", size=6, file.main, "bottomright", c("red", "lightcoral", "skyblue3", "blue"), NULL, flip.x=-1, flip.y=1, legend.title=NA)
