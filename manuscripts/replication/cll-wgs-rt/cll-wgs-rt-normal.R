...
plotPCA(1, 2, pca.de, trait, wd.rt.plots, "PCA_CLL-WB", size=6, file.main, "bottomright", c(red, red.lighter, blue.lighter, blue), NULL, flip.x=-1, flip.y=1, legend.title=NA)
