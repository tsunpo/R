...
samples1 <- readTable(file.path(wd.ngs, "cll_wgs_n96.txt"), header=T, rownames=T, sep="")
#samples1 <- readTable(file.path(wd.ngs, "cll_wgs_n48.txt"), header=T, rownames=T, sep="")
samples1 <- subset(samples1, RT == 1)[,1]
samples0 <- readTable(file.path(wd.ngs, "cll_wgs_n96.txt"), header=T, rownames=T, sep="")
#samples0 <- readTable(file.path(wd.ngs, "cll_wgs_n48.txt"), header=T, rownames=T, sep="")
...
for (c in 1:22) {
   ...
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M2 tumour", "M1 tumour"), c(adjustcolor.gray, adjustcolor.gray), c("M2", "M1"), "png", width=10, peaks=c(74353001, 85951001), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " M2/M1 read depth ratio"), chr, 71500000, 90500000, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M2", "M1"), c(adjustcolor.red, adjustcolor.blue), c("M2", "M1"), "png", width=5, peaks=c(74353001, 85951001), 7.5, 9.25, 3, 3)
   ...
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M1 tumour", "M0 tumour"), c(adjustcolor.gray, adjustcolor.gray), c("M1", "M0"), "png", width=10, peaks=c(6215805,	6257983), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " M1/M0 read depth ratio"), chr, 1215805,	11257983, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M1", "M0"), c(adjustcolor.red, adjustcolor.blue), c("M1", "M0"), "png", width=5, peaks=c(6215805,	6257983), 7.5, 9.25, 3, 3)
   
   ## BTBD1 (chr15)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_BTBD1"))
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M1 tumour", "M0 tumour"), c(adjustcolor.gray, adjustcolor.gray), c("M1", "M0"), "png", width=10, peaks=c(83685174,	83736106), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " M1/M0 read depth ratio"), chr, 78685174,	88736106, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M1", "M0"), c(adjustcolor.red, adjustcolor.blue), c("M1", "M0"), "png", width=5, peaks=c(83685174,	83736106), 7.5, 9.25, 3, 3)
   
   ## XRCC6 (chr22)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_XRCC6"))
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M1 tumour", "M0 tumour"), c(adjustcolor.gray, adjustcolor.gray), c("M1", "M0"), "png", width=10, peaks=c(42017123,	42060044), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " M1/M0 read depth ratio"), chr, 37017123,	47060044, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M1", "M0"), c(adjustcolor.red, adjustcolor.blue), c("M1", "M0"), "png", width=5, peaks=c(42017123,	42060044), 7.5, 9.25, 3, 3)
   
   ## AHR (chr7)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_AHR"))
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M1 tumour", "M0 tumour"), c(adjustcolor.gray, adjustcolor.gray), c("M1", "M0"), "png", width=10, peaks=c(17338246,	17385776), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " M1/M0 read depth ratio"), chr, 12338246,	22385776, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M1", "M0"), c(adjustcolor.red, adjustcolor.blue), c("M1", "M0"), "png", width=5, peaks=c(17338246,	17385776), 7.5, 9.25, 3, 3)
   ...
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.gray, adjustcolor.gray), c("T29", "T33"), "png", width=10, peaks=c(74225473, 74233520), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 69225473, 79233520, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(74225473, 74233520), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 73725473, 74733520, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(74225473, 74233520), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 74175473, 74283520, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(74225473, 74233520), 7.5, 9.25, 3, 3)
   
   ## SLFN12 (chr17)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_SLFN12"))
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.gray, adjustcolor.gray), c("T29", "T33"), "png", width=10, peaks=c(33738079, 33760302), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 27738079, 38760302, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(33738079, 33760302), 7.5, 9.25, 3, 3)

   ## KLRC4 (chr12)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_KLRC4"))
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.gray, adjustcolor.gray), c("T29", "T33"), "png", width=10, peaks=c(10559983, 10562356), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 5559983, 15562356, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(10559983, 10562356), 7.5, 9.25, 3, 3)
   

   ## MANEAL (chr1)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_MANEAL"))
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.gray, adjustcolor.gray), c("T29", "T33"), "png", width=10, peaks=c(38259474, 38266809), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 33259474, 43266809, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(38259474, 38266809), 7.5, 9.25, 3, 3)
   
   ## chr12
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_chr12"))
   plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.gray, adjustcolor.gray), c("T29", "T33"), "png", width=10, peaks=c(21507893, 21532912, 39687030, 39837192, 46312914, 46385903), 7.5, 9.25, 3, 3)
   
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_chr12_IAPP"))
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 16507893, 26532912, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(21507893, 21532912, 39687030, 39837192, 46312914, 46385903), 7.5, 9.25, 3, 3)

   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_chr12_KIF21A"))
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 34687030, 44837192, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(21507893, 21532912, 39687030, 39837192, 46312914, 46385903), 7.5, 9.25, 3, 3)
   
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_chr12_SCAF11"))
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 41312914, 51385903, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(21507893, 21532912, 39687030, 39837192, 46312914, 46385903), 7.5, 9.25, 3, 3)
   
   
   ## PD-L1 / CD274 (chr9)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_PD-L1"))
   ...
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 450503, 10450503, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(32485120, 32498064), 7.5, 9.25, 3, 3)

   ## PD-1 / PDCD1 (chr2)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_PD-1"))
   #plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.gray, adjustcolor.gray), c("T29", "T33"), "png", width=10, peaks=c(32485120, 32498064), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 237801060, 247801060, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(32485120, 32498064), 7.5, 9.25, 3, 3)
   
   ## KLRC3 (chr12)
   file.name <- file.path(wd.rt.plots, paste0("RTD_", base0, "_rpkm.corr.gc.d.rt_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_KLRC3"))
   #plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.gray, adjustcolor.gray), c("T29", "T33"), "png", width=10, peaks=c(10564911,	10573194), 7.5, 9.25, 3, 3)
   plotRD3(file.name, paste0(BASE1, " T29/T33 read depth ratio"), chr, 10000000,	11000000, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour (n=29)", "Tumour (n=33)"), c(adjustcolor.red, adjustcolor.blue), c("T29", "T33"), "png", width=5, peaks=c(10564911,	10573194), 7.5, 9.25, 3, 3)
...
# -----------------------------------------------------------------------------
genes <- c("ERCC6L2", "PDCL3P5", "DUSP4", "FOS")
genes <- c("GNAQ", "VEGFA")
genes <- c("IL6ST")
...
for (g in 1:length(genes)) {
   ...
   if (plotWholeChr)
      plotRD3(file.name, main.text, chr, NA, NA, rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("Tumour", "Normal"), c(adjustcolor.gray, adjustcolor.gray), c("M2", "M1"), "png", width=10, peaks=c(start, end), 7.5, 9.25, 3, 3)
 
   for (r in 1:length(ranges))
      plotRD3(file.name, paste0(BASE1, " M2/M1 read depth ratio"), chr, start-ranges[r],	end+ranges[r], rpkms.chr.rt, bed.gc.chr, c("red", "blue"), c("M2", "M1"), c(adjustcolor.red, adjustcolor.blue), c("M2", "M1"), "png", width=5, peaks=c(start, end), 7.5, 9.25, 3, 3)
}
...
for (c in 1:22) {
   ...
   main.text <- paste0("CLL RT (M2/M1) vs. Read depths (", "Chr", c, ")")
   xlab.text <- "CLL RT (M2/M1)"
   ylab.text <- "CLL read depth"
   file.name <- file.path(wd.rt.plots, paste0("plot_RT-M2-M1-vs-RD_CLL_pearson_chr", c))
...
save(cors, file=file.path(wd.rt.data, paste0("rt-vs-rt_", "cll-M2-M1", "-vs-lcl_cors-pearson.RData")))

ylab.text <- "Pearson's r"
xlab.text <- "Chromosome"
file.name <- file.path(wd.rt.plots, "plot_RT-M2-M1-vs-RT_CLL-vs-LCL_pearson")
main.text <- paste0("CLL RT (M2/M1) vs. LCL RT")
ymin <- 0
ymax <- 0.8
plotRTvsRTALL(cors, file.name, main.text, ylab.text, xlab.text, ymin, ymax, line0=T)

# -----------------------------------------------------------------------------
# CLL M2/M1 RT vs CLL Q4/Q1 RT
...
for (c in 1:22) {
   ...
   #rpkms.chr.rt.lcl <- readTable(paste0("/Users/tpyang/Work/uni-koeln/tyang2/SCLC/analysis/replication/sclc-wgs-rt/data/sclc_rpkm.corr.gc.d.rt_", chr, "_", "T", "-", "T", "_n", 50, "-", 51, ".txt.gz"), header=T, rownames=T, sep="\t")
   rpkms.chr.rt.lcl <- setScaledRT(rpkms.chr.rt.lcl, pseudocount=0.01, recaliRT=T, flipRT=F, scaledRT=T) 
   rpkms.chr.rt.lcl.RT <- setSlope(rpkms.chr.rt.lcl, bed.gc.chr, "RT")
...
save(cors, file=file.path(wd.rt.data, paste0("rt-vs-rt_CLL-M2-M1-vs-LCL-S-G1_cors-pearson.RData")))

ylab.text <- "Pearson's r"
xlab.text <- "Chromosome"
file.name <- file.path(wd.rt.plots, "plot_rt-vs-rt_CLL-M2-M1-vs-LCL-S-G1_cors-pearson")
...
main.text <- c("CLL (n=96) RD (T) vs. LCL RT", "CLL RD (T) vs. LCL RT")   ## TO-DO
ymin <- -0.6920546
ymax <- 0.6621544
...
samples1 <- readTable(file.path(wd.ngs, "cll_wgs_n96_union_rt31.list"), header=F, rownames=F, sep="")
samples0 <- readTable(file.path(wd.ngs, "cll_wgs_n96_union_wt36.list"), header=F, rownames=F, sep="")

phenos <- toTable(NA, 2, length(samples), c("SAMPLE_ID", "RT"))
rownames(phenos) <- samples
phenos$SAMPLE_ID <- samples
phenos[samples1,]$RT <- 1
phenos[samples0,]$RT <- 0

trait <- as.numeric(phenos$RT)
trait[which(trait == 1)] <- "CLL T31 (Cycling)"
trait[which(trait == 0)] <- "CLL T36 (Resting)"
trait[which(is.na(trait))] <- "CLL T29 (Varied)"
...
for (c in 22:1) {
   ...
   ##
   test <- rpkms.T.chr.d[overlaps, samples]
   pca.de <- getPCA(t(test))
   
   file.main <- c(paste0("PCA of CLL samples on chromosome ", c), "")
   plotPCA(1, 2, pca.de, trait, wd.rt.plots, paste0("pca_cll_chr", c), size=6.5, file.main, "topleft", c("gray", "red", "dodgerblue"), NULL, flip.x=1, flip.y=1)
   save(pca.de, file=file.path(wd.rt.data, paste0("pca_cll_chr", c, "_all.RData")))
...
file.main <- c("PCA of CLL samples on all chromosomes", "")
plotPCA(1, 2, pca.de, trait, wd.rt.plots, "pca_cll_chrs", size=6.5, file.main, "topleft", c("gray", "red", "dodgerblue"), NULL, flip.x=1, flip.y=1)
...
# [1] 2
# > s_likes
# [1] "SP116746" "SP116750" "SP13347"  "SP13421"  "SP13490" 
# > g1_likes
# [1] "SP13478" "SP13624"
