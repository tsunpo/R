...
# Name         : manuscripts/replication/cll-wgs-rt-q4.R
...
for (c in 1:22) {
   ...
   ## Plot RT
   main.text <- paste0(BASE, " Q4/Q1 read depth ratio between tumour (n=", n1, ") and tumour (n=", n0, ") cells")  
...
for (c in 1:22) {
   ...
   main.text <- c(paste0("CLL read depth correlation (", "Chr", c, ")"), paste0("rho = ", round0(sprs$cor[c], digits=2), " (Q4 vs. Q1)"))
   xlab.text <- "CLL Q4/Q1"
