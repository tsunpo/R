...
for (c in 1:22) {
   ...
   main.text <- c(paste0("CLL read depths vs. CLL Q4/Q1 (", "Chr", c, ")"), paste0("rho = ", round0(cor, digits=2), " (Q4 vs. Q1)"))
   xlab.text <- "CLL Q4/Q1"
...
## Read depth skew (RDS)
file.name <- file.path(wd.rt.plots, "RDS_CLL-Q4-Q1_spline_spearman")
