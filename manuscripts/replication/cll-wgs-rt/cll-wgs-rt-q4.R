...
samples1 <- readTable(file.path(wd.ngs, "cll_wgs_q4_n48.txt"), header=T, rownames=T, sep="")    ## Q3/Q1
samples1 <- subset(samples1, M2 == 1)[,1]
#samples0 <- readTable(file.path(wd.ngs, "cll_wgs_n96.txt"), header=T, rownames=T, sep="")
samples0 <- readTable(file.path(wd.ngs, "cll_wgs_q4_n48.txt"), header=T, rownames=T, sep="")
...
ylab.text <- "SPR"
file.name <- file.path(wd.rt.plots, "SPR_CLL-Q4-Q1_spline_spearman")
...
file.name <- file.path(wd.rt.plots, "SPR-RDC_CLL-Q4-Q1_spline_spearman")
...
file.name <- file.path(wd.rt.plots, "SPR-Woodfine_CLL-Q4-Q1_spline_spearman")
...
##
file.name <- file.path(wd.rt.plots, "RTD-vs-RT_CLL-Q4-Q1-vs-LCL-S-G1_spline_spearman")
ymin <- -1.1
ymax <- 1.1
