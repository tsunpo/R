...
for (c in 1:22) {
   ...
   main.text <- c(paste0("CLL read depths vs. CLL M2/M1 (", "Chr", c, ")"), paste0("rho = ", round0(cor, digits=2), " (M2 vs. M1)"))
   xlab.text <- "CLL M2/M1"
...
file.name <- file.path(wd.rt.plots, "RDS-SPR_CLL-M2-M1_spline_spearman")
...
file.name <- file.path(wd.rt.plots, "RDS-SPR-RDC_CLL-M2-M1_spline_spearman")
