...
file.name <- file.path(wd.rt.plots, "MRTR-RDC_CLL-M2-M1_spline_spearman")
...
file.name <- file.path(wd.rt.plots, "MRTR-Woodfine_CLL-M2-M1_spline_spearman")
...
## CLL Q4/Q1
nrds.tmp <- nrds
load(file.path(wd, "SCLC/analysis/replication/sclc-wgs-rt/data", paste0("nrds_sclc-t-n_", method, ".RData")))
nrds.q4 <- nrds
nrds <- nrds.tmp
...
main.text <- paste0("CLL M2/M1 vs. SCLC T/N")
ymin <- 0.25
ymax <- 1.05
