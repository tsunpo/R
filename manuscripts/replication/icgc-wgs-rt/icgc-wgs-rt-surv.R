...
# Last Modified: 31/03/22
# -----------------------------------------------------------------------------
file.name <- "stripchart_ICGC_samples.surv_OS_0.5_1.7"
...
y <- -log10(pvals[-idx])
file.name <- paste0("/Users/tpyang/Work/uni-koeln/tyang2/ICGC/analysis/replication/icgc-wgs-rt/plots/correlation_in-silico_P_KM_OS_1580_P_green_lwd=3_test")
