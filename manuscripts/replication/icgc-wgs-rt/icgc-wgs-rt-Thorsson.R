...
# Define features to test against COR
features <- c(
   "TCRA.tcell.fraction.tumour", "TCRA.tcell.fraction.blood", "shannon.TRAV.div.tumour", "shannon.TRAV.div.blood",
   "shannon.TRAJ.div.tumour", "shannon.TRAJ.div.blood", "TCRB.tcell.fraction.tumour", "TCRB.tcell.fraction.blood",
   "shannon.TRBV.div.tumour", "shannon.TRBV.div.blood", "shannon.TRBJ.div.tumour", "shannon.TRBJ.div.blood",
   "TCRG.tcell.fraction.tumour", "TCRG.tcell.fraction.blood", "shannon.TRGV.div.tumour", "shannon.TRGV.div.blood",
   "shannon.TRGJ.div.tumour", "shannon.TRGJ.div.blood", "IGH.bcell.fraction.tumour", "IGH.bcell.fraction.blood",
   "igA.frac.tumour", "igA.frac.blood", "igG.frac.tumour", "igG.frac.blood", "igE.frac.tumour", "igE.frac.blood",
   "igMD.frac.tumour", "igMD.frac.blood", "shannon.IGHV.div.tumour", "shannon.IGHV.div.blood",
   "shannon.IGHJ.div.tumour", "shannon.IGHJ.div.blood", "purity", "TCRA.cn", "TCRB.cn", "TCRG.cn", "IGH.cn"
)
...
for (feature in features) {
   ...
   if (sum(valid_rows) >= 3) {
      ...
      # Optional: plot correlation
      file.name <- file.path(wd.rt.plots, "Thorsson 2018", paste0("Cor_SCF-vs-", feature, ".pdf"))
      main.text <- c("", "")
      xlab.text <- feature
      ylab.text <- "SCF index"
      plotCorrelation(file.name, main.text, xlab.text, ylab.text,
...
file.name <- file.path(wd.rt.plots, "Bentham 2025", paste0("Cor_SCF-vs-", col, "_"))
main.text <- c("Bentham 2025", "")
