...
for (c in 2:2) {
   ...
   file.name <- file.path(wd.rt.plots, "with-LCL", paste0("RT_", BASE, "_", method, ".d.rt.log2s_", chr, "_", PAIR1, "-", PAIR0, "_n", n1, "-", n0, "_150dpi"))  
...
##
file.name <- file.path(wd.rt.plots, "RTD-vs-RT_NBL-NL-M2-M1-vs-LCL-S-G1_spline_spearman")
