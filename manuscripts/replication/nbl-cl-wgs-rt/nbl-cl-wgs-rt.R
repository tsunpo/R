...
plotPCA(1, 2, pca.de, trait, wd.rt.plots, "PCA_NBL-CL_chrs", size=6, file.main, "topright", c("red", "lightpink1", "lightskyblue2", "blue"), samples1, flip.x=-1, flip.y=1, legend.title=NA)
