...
wd.rt       <- file.path(wd.anlys, "replication", paste0(base, "-wes-rt-m2"))
wd.rt.data  <- file.path(wd.rt, "data")
wd.rt.plots <- file.path(wd.rt, "plots")

samples1 <- readTable(file.path(wd.ngs, "sclc_wes_m2_n17.txt"), header=T, rownames=T, sep="")
#samples1 <- readTable(file.path(wd.ngs, "sclc_wgs_n51.txt"), header=T, rownames=T, sep="")
samples1 <- subset(samples1, M2 == 2)[,1]
samples0 <- readTable(file.path(wd.ngs, "sclc_wes_m2_n17.txt"), header=T, rownames=T, sep="")
...
load(file.path(wd, "LCL/analysis/replication/lcl-wes-rt/data/lcl_rpkm.gc.cn.m.rt.log2s_s-g1_peiflyne_wes_new.RData"))
nrds.lcl <- nrds
...
for (c in 1:22) {
   ...
   ## Plot RT
   main.text <- paste0(BASE, " WES M2 to M1 ratio replication timing (RT)")  
...
for (c in 1:22) {
   ...
   main.text <- c(paste0("SCLC read depth correlation (", "Chr", c, ")"), paste0("rho = ", round0(sprs$cor[c], digits=2), " (M2 vs. M1)"))
...
ylab.text <- "SCLC M2/M1"
plotRTS2(sprs.sclc$spr, lcl.mean$Mean, file.name, main.text, c(4, 13, 17, 19, 22), xlab.text, unit=5, ylab.text)

file.name <- file.path(wd.rt.plots, "RTS2_Woodfine_vs_SCLC-NL-M2-M1_spline_spearman")
main.text <- c("Mean replication timing ratio", "")
xlab.text <- "Woodfine et al. 2004"
ylab.text <- "SCLC-NL M2/M1"
plotRTS2(sprs.sclc.nl$spr, lcl.mean$Mean, file.name, main.text, c(4, 13, 17, 19, 22), xlab.text, unit=5, ylab.text)

file.name <- file.path(wd.rt.plots, "RTS2_Woodfine_vs_NBL-M2-M1_spline_spearman")
main.text <- c("Mean replication timing ratio", "")
xlab.text <- "Woodfine et al. 2004"
ylab.text <- "NBL M2/M1"
plotRTS2(sprs.nbl$spr, lcl.mean$Mean, file.name, main.text, c(4, 13, 17, 19, 22), xlab.text, unit=5, ylab.text)

file.name <- file.path(wd.rt.plots, "RTS2_Woodfine_vs_CLL-M2-M1_spline_spearman")
main.text <- c("Mean replication timing ratio", "")
xlab.text <- "Woodfine et al. 2004"
ylab.text <- "CLL M2/M1"
...
## SCLC vs Woodfine 2004
file.name <- file.path(wd.rt.plots, "RTS2_SCLC-M2-M1_vs_Woodfine_spline_spearman")
main.text <- c("Mean replication timing ratio", "")
xlab.text <- "Woodfine et al. 2004"
ylab.text <- "SCLC M2/M1"
plotRTS2(sprs.sclc$spr, lcl.mean$Mean, file.name, main.text, c(13, 17, 19, 22), xlab.text, unit=5, ylab.text)
...
save(cors, file=file.path(wd.rt.data, paste0("rt-vs-rt_", base, "-m2-m1-vs-lcl-s-g1_spline_spearman_wes_new.RData")))
#load(file.path(wd.rt.data, paste0("rt-vs-rt_", base, "-m2-m1-vs-lcl-s-g1_spline_spearman.RData")))

##
file.name <- file.path(wd.rt.plots, "RTD-vs-RT_SCLC-M2-M1-vs-LCL-S-G1_spline_spearman_wes_new")
main.text <- paste0("SCLC WES M2/M1 vs. LCL WES S/G1")
ymin <- -1.1
ymax <- 1.1
...
file.name <- file.path(wd.rt.plots, "RT-vs-RT2_SCLC-M2-M1-vs-ALL")   ## gold (#f6c700)
...
file.name <- file.path(wd.rt.plots, "RT-vs-RT2_SCLC-M2-M1-vs-ALL_0")   ## gold (#f6c700)
...
ymin <- 0.2
ymax <- 1
plotRTvsRT2(cors, file.name, main.text, ymin, ymax, cols=c("white", yellow), c("", "SCLC vs. NBL-CL "))   #00BA38 green for LCL RT??
# > median(cors$cor1)
# [1] 0.7900603
...
# -----------------------------------------------------------------------------
cors <- getRTvsRT3(nrds.sclc.m2, nrds.sclc.m2, nrds.luad.m2, nrds.lcl, bed.gc)
...
file.name <- file.path(wd.rt.plots, "RT-vs-RT2_SCLC-M2-M1-vs-LUAD_spline_spearman")   ## gold (#f6c700)
main.text <- paste0(BASE, " M2/M1")
ymin <- 0.55
ymax <- 0.9
plotRTvsRT2(cors, file.name, main.text, ymin, ymax, cols=c("white", yellow), c("", "SCLC vs. LUAD "))   #00BA38 green for LCL RT??
# median(cors$cor1)
# [1] 0.7924245
...
# -----------------------------------------------------------------------------
samples <- readTable(file.path(wd.ngs, "sclc_wgs_n101.txt"), header=T, rownames=T, sep="")   ## M2/M1
...
plot(samples$COR, wgds$decision_value, ylab="", xlab=xlab.text, main="SCLC (n=101)", col="black", pch=1, cex=2, cex.axis=1.7, cex.lab=1.7, cex.main=1.8)
...
## SCLC Q4/Q1
nrds.tmp <- nrds
load(file.path(wd, "NBL/analysis/replication/nbl-wgs-rt-m2/data", paste0("nrds_nbl-t-t_", method, ".RData")))
nrds.q4 <- nrds
nrds <- nrds.tmp
...
main.text <- paste0("SCLC M2/M1 vs. NBL M2/M1")
ymin <- 0.25
ymax <- 1.05
...
# Last Modified: 09/08/19; 06/06/19
# -----------------------------------------------------------------------------
getSplineRT <- function(nrds, bed.gc) {
   nrds.RT <- toTable(0, 3, 0, c("BED", "RT", "SPLINE"))
...
###
##
nrds.sclc.o.RT$SIGN <- nrds.sclc.o.RT$SPLINE * nrds.nbl.o.RT$SPLINE
nrds.nbl.o.RT$SIGN <- nrds.sclc.o.RT$SPLINE * nrds.nbl.o.RT$SPLINE
length(which(nrds.sclc.o.RT$SIGN > 0))
length(which(nrds.nbl.o.RT$SIGN > 0))
# [1] 2486865
# > 2486865/2638822
# [1] 0.9424148
...
xlab.text <- "SCLC RT"
ylab.text <- "NBL RT"
file.name <- file.path(wd.rt.plots, paste0("RT-vs-RT_SCLC-vs-NBL_SPLINE_spline_spearman"))
plotRTvsRT(nrds.sclc.o.RT$SPLINE, nrds.nbl.o.RT$SPLINE, file.name, main.text, xlab.text, ylab.text, method="spearman")

###
##
nrds.sclc.o.RT$SIGN <- nrds.sclc.o.RT$SPLINE * nrds.cll.o.RT$SPLINE
nrds.cll.o.RT$SIGN <- nrds.sclc.o.RT$SPLINE * nrds.cll.o.RT$SPLINE
length(which(nrds.sclc.o.RT$SIGN > 0))
length(which(nrds.cll.o.RT$SIGN > 0))
# [1] 2359995
# > 2359995/2638822
# [1] 0.8943366
...
xlab.text <- "SCLC RT"
ylab.text <- "CLL RT"
file.name <- file.path(wd.rt.plots, paste0("RT-vs-RT_SCLC-vs-CLL_SPLINE_spline_spearman"))
plotRTvsRT(nrds.sclc.o.RT$SPLINE, nrds.cll.o.RT$SPLINE, file.name, main.text, xlab.text, ylab.text, method="spearman")

###
##
nrds.nbl.o.RT$SIGN <- nrds.nbl.o.RT$SPLINE * nrds.cll.o.RT$SPLINE
nrds.cll.o.RT$SIGN <- nrds.nbl.o.RT$SPLINE * nrds.cll.o.RT$SPLINE
length(which(nrds.nbl.o.RT$SIGN > 0))
length(which(nrds.cll.o.RT$SIGN > 0))
# [1] 2307000
# > 2307000/2638822
...
xlab.text <- "CLL RT"
ylab.text <- "NBL RT"
file.name <- file.path(wd.rt.plots, paste0("RT-vs-RT_CLL-vs-NBL_SPLINE_spline_spearman"))
plotRTvsRT(nrds.cll.o.RT$SPLINE, nrds.nbl.o.RT$SPLINE, file.name, main.text, xlab.text, ylab.text, method="spearman")

# -----------------------------------------------------------------------------
# 
# Last Modified: 09/08/19; 06/06/19
# -----------------------------------------------------------------------------
overlaps <- intersect(intersect(intersect(rownames(nrds.sclc), rownames(nrds.nbl)), rownames(nrds.cll)), rownames(nrds.lcl))
nrds.sclc.o <- nrds.sclc[overlaps,]
nrds.nbl.o  <- nrds.nbl[overlaps,]
nrds.cll.o  <- nrds.cll[overlaps,]
nrds.lcl.o  <- nrds.lcl[overlaps,]
length(overlaps)
# [1] 2576838
...
nrds.nbl.o.RT  <- getSplineRT(nrds.nbl.o, bed.gc)
nrds.cll.o.RT  <- getSplineRT(nrds.cll.o, bed.gc)
nrds.lcl.o.RT  <- getSplineRT(nrds.lcl.o, bed.gc)
nrow(nrds.sclc.o.RT)
# [1] 2527143

###
##
nrds.sclc.o.RT$SIGN <- nrds.sclc.o.RT$SPLINE * nrds.lcl.o.RT$SPLINE
nrds.lcl.o.RT$SIGN <- nrds.sclc.o.RT$SPLINE * nrds.lcl.o.RT$SPLINE
length(which(nrds.sclc.o.RT$SIGN > 0))
length(which(nrds.lcl.o.RT$SIGN > 0))
# [1] 2023985
# > 2023985/2527143
# [1] 0.8008985
...
###
##
nrds.nbl.o.RT$SIGN <- nrds.nbl.o.RT$SPLINE * nrds.lcl.o.RT$SPLINE
nrds.lcl.o.RT$SIGN <- nrds.nbl.o.RT$SPLINE * nrds.lcl.o.RT$SPLINE
length(which(nrds.nbl.o.RT$SIGN > 0))
length(which(nrds.lcl.o.RT$SIGN > 0))
# [1] 1983321
# > 1983321/2527143
...
###
##
nrds.cll.o.RT$SIGN <- nrds.cll.o.RT$SPLINE * nrds.lcl.o.RT$SPLINE
nrds.lcl.o.RT$SIGN <- nrds.cll.o.RT$SPLINE * nrds.lcl.o.RT$SPLINE
length(which(nrds.cll.o.RT$SIGN > 0))
length(which(nrds.lcl.o.RT$SIGN > 0))
# [1] 2009343
# > 2009343/2527143
...
###
##
nrds.sclc.o$SIGN <- nrds.sclc.o$RT * nrds.nbl.o$RT
nrds.nbl.o$SIGN <- nrds.sclc.o$RT * nrds.nbl.o$RT
length(which(nrds.sclc.o$SIGN > 0))
length(which(nrds.nbl.o$SIGN > 0))
# [1] 2234688
# > 2234688/2649168
# [1] 0.8435433
...
xlab.text <- "SCLC RT"
ylab.text <- "NBL RT"
file.name <- file.path(wd.rt.plots, paste0("RT-vs-RT_SCLC-vs-NBL_spline_spearman"))
plotRTvsRT(nrds.sclc.o$RT, nrds.nbl.o$RT, file.name, main.text, xlab.text, ylab.text, method="spearman")

###
##
nrds.sclc.o$SIGN <- nrds.sclc.o$RT * nrds.cll.o$RT
nrds.cll.o$SIGN <- nrds.sclc.o$RT * nrds.cll.o$RT
length(which(nrds.sclc.o$SIGN > 0))
length(which(nrds.cll.o$SIGN > 0))
# [1] 2052633
# > 2052633/2649168
# [1] 0.7748218
...
xlab.text <- "SCLC RT"
ylab.text <- "CLL RT"
file.name <- file.path(wd.rt.plots, paste0("RT-vs-RT_SCLC-vs-CLL_spline_spearman"))
plotRTvsRT(nrds.sclc.o$RT, nrds.cll.o$RT, file.name, main.text, xlab.text, ylab.text, method="spearman")

##
nrds.nbl.o$SIGN <- nrds.nbl.o$RT * nrds.cll.o$RT
nrds.cll.o$SIGN <- nrds.nbl.o$RT * nrds.cll.o$RT
length(which(nrds.nbl.o$SIGN > 0))
length(which(nrds.cll.o$SIGN > 0))
# [1] 2021435
# > 2021435/2649168
...
xlab.text <- "CLL RT"
ylab.text <- "NBL RT"
file.name <- file.path(wd.rt.plots, paste0("RT-vs-RT_CLL-vs-NBL_spline_spearman"))
plotRTvsRT(nrds.cll.o$RT, nrds.nbl.o$RT, file.name, main.text, xlab.text, ylab.text, method="spearman")
...
##
nrds.sclc.o$SIGN <- nrds.sclc.o$RT * nrds.lcl.o$RT
nrds.lcl.o$SIGN <- nrds.sclc.o$RT * nrds.lcl.o$RT
length(which(nrds.sclc.o$SIGN > 0))
length(which(nrds.lcl.o$SIGN > 0))
# [1] 1657917
# > 1657917/2576838
# [1] 0.643392

##
nrds.nbl.o$SIGN <- nrds.nbl.o$RT * nrds.lcl.o$RT
nrds.lcl.o$SIGN <- nrds.nbl.o$RT * nrds.lcl.o$RT
length(which(nrds.nbl.o$SIGN > 0))
length(which(nrds.lcl.o$SIGN > 0))
# [1] 1618698
# > 1618698/2576838
...
##
nrds.cll.o$SIGN <- nrds.cll.o$RT * nrds.lcl.o$RT
nrds.lcl.o$SIGN <- nrds.cll.o$RT * nrds.lcl.o$RT
length(which(nrds.cll.o$SIGN > 0))
length(which(nrds.lcl.o$SIGN > 0))
# [1] 1673260
# > 1673260/2576838
