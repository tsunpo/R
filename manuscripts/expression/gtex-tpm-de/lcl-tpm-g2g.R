...
# =============================================================================
load(file.path(wd, "GTEx", "analysis/expression/kallisto", paste0(base, "-tpm-de/data/", base, "_kallisto_0.43.1_tpm.gene_r5_p47.RData")))
...
# 0%        25%        50%        75%       100% 
# -6.01318101 -0.08985843  3.10447349  4.82868867 13.58708021
...
c(p1, p2, p3)
# [1] 3.912574e-32 7.975823e-13 9.268577e-08
p.adjust(c(p1, p2, p3), method="bonferroni")
# [1] 1.173772e-31 2.392747e-12 2.780573e-07
