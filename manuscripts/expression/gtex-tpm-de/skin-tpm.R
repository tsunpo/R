...
# Manuscript   :
# Chapter      :
# Name         : manuscripts/expression/wb-tpm-de.R
...
samples <- readTable(file.path(wd.rna, "gtex_skin_rna.list"), header=F, rownames=F, sep="")
samples <- samples$V1
...
# 80589 targets passed the filter
# normalizing tpm
# merging in metadata
# aggregating by column: ens_gene
# 20510 genes passed the filter
...
# > nrow(tpm.gene)
# [1] 16537
# > 18853 - 16537   ## Different with line 105
