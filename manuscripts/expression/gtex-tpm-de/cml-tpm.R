...
samples <- readTable(file.path(wd.rna, "gtex_cml_rna.list"), header=F, rownames=F, sep="")
samples <- samples$V1
...
# 78799 targets passed the filter
# normalizing tpm
# merging in metadata
# aggregating by column: ens_gene
# 19056 genes passed the filter
