...
# Manuscript   :
# Chapter      :
# Name         : manuscripts/expression/adipose-tpm-de.R
...
samples <- readTable(file.path(wd.rna, "gtex_adipose_rna.list"), header=F, rownames=F, sep="")
samples <- samples$V1
...
# 80868 targets passed the filter
# normalizing tpm
# merging in metadata
# aggregating by column: ens_gene
# 19954 genes passed the filter
