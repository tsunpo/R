...
samples <- readTable(file.path(wd.rna, "gtex_wb_rna.list"), header=F, rownames=F, sep="")
samples <- samples$V1
...
# 63104 targets passed the filter
# normalizing tpm
# merging in metadata
# aggregating by column: ens_gene
# 17585 genes passed the filter
