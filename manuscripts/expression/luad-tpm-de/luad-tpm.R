...
# -----------------------------------------------------------------------------
wd <- "/ngs/cangen/tyang2/LUAD/"                     ## tyang2@gauss
#wd <- "/Users/tpyang/Work/uni-koeln/tyang2/LUAD/"   ## tyang2@local
wd.rna <- paste0(wd, "ngs/RNA/")
wd.rna.kallisto <- paste0(wd.rna, "kallisto_hg19.ensembl_quant-b100--bias--fusion/")
wd.de <- paste0(wd, "analysis/expression/kallisto/luad-tpm-de/")

samples <- readTable(paste0(wd.rna, "luad_rna_n49-1.list"), header=F, rownames=F, sep="\t")   ## ADD 28/04/18: S01728 is SCLC
...
save(tpm.norm,      file=paste0(wd.de, "data/luad_kallisto_0.43.1_tpm.norm_r5_p47.RData"))
save(tpm.norm.filt, file=paste0(wd.de, "data/luad_kallisto_0.43.1_tpm.norm.filt_r5_p47.RData"))
...
save(tpm.gene, file=paste0(wd.de, "data/luad_kallisto_0.43.1_tpm.gene_r5_p47.RData"))
