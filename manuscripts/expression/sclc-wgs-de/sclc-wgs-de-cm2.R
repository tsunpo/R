...
samples <- readTable(file.path(wd.wgs, "sclc_wgs_n70.cm2"), header=T, rownames=T, sep="")[,-1]
...
file.name <- paste0("de_", base, "_wgs-gene_cm2_wilcox_q_n70")
...
save(wgs.gene, file=file.path(wd.de.data, paste0(base, "_wgs.gene_n70.RData")))
save(tpm.gene, file=file.path(wd.de.data, paste0(base, "_tpm.gene_n70.RData")))
# > dim(tpm.gene)
# [1] 18371    70
# > dim(wgs.gene)
# [1] 18371   70
...
save(de.tpm.wgs.gene, samples, file=file.path(wd.de.data, "de_sclc_tpm-wgs-gene_cm2_src_q_n70.RData"))
writeTable(de.tpm.wgs.gene, file.path(wd.de.data, "de_sclc_tpm-wgs-gene_cm2_src_q_n70.txt"), colnames=T, rownames=F, sep="\t")
