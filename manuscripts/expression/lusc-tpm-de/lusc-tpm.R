...
wd.rna   <- file.path(wd, BASE, "ngs/RNA", BASE)
...
samples <- readTable(file.path(wd.rna, "lusc_rna_n423.list"), header=F, rownames=T, sep="")[,1]
...
# 85724 targets passed the filter
# normalizing tpm
# merging in metadata
# aggregating by column: ens_gene
# 21600 genes passed the filter
