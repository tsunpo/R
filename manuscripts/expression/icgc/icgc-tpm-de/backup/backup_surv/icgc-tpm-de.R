...
length(overlaps)
# [1] 395
samples.tpm <- samples.surv[overlaps,]
#samples.tpm$SG1 <- "G1"
...
# Samples with MUT SG1: 120
# Samples with  WT SG1: 275
...
file.name <- paste0("de_", base, "_tpm-gene-median0_SEX_wilcox_q_n395")
file.main <- paste0("", BASE)

de <- differentialAnalysis(tpm.gene.log2, samples.tpm, argv$predictor, argv$predictor.wt, argv$test, argv$test.fdr)
# Samples with MUT donor_sex: 205
# Samples with  WT donor_sex: 190
