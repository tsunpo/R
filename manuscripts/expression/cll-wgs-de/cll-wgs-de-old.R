...
plotVolcano <- function(de, pvalue, genes, file.de, file.main) {
   ...
   plot(de$LOG2_FC, de$log10P, pch=16, xlim=c(-xmax, xmax), ylim=c(0, ymax), xlab="log2FC(CLL T29/T33)", ylab="-log10(Fishers' combined p-value)", col="darkgray", main=file.main[1], xaxt="n")
...
##
plot.main <- "Gene read depth difference between T29 and T33 in CLL"
