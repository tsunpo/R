...
# > nrow(tpm.gene)
# [1] 16760
# > 16760 - 16645   ## Different with line 105
# [1] 115   ## Genes with no 0 TPM in any of the samples, but failed at least 5 read in 47% of the samples (i.e. very low-expressed genes)

###
## Gene list after default filtering
tpm.gene.patch <- list2Matrix(tpm.norm.filt$tpm, tpm.norm.filt)   ## Gene-level TPMs with patches
# > nrow(tpm.gene.patch)
# [1] 20410   ## Matched to line 59
