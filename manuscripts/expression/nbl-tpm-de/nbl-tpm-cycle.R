...
# Manuscript   : 
# Chapter I    : 
# Name         : manuscripts/expression/nbl-tpm-cycle.R
...
samples <- readTable(file.path(wd.rna, "nbl_rna_n54.list"), header=F, rownames=T, sep="")
colnames(samples) <- c("SAMPLE_ID", "SAMPLE_ID2", "FILE_NAME", "AVG_FRAGMENT_LENGTH", "MAX_INSERT_SIZE")
...
periodic.G1S <- intersect(periodic.G1S, rownames(tpm.gene.log2))   ## 276/304
