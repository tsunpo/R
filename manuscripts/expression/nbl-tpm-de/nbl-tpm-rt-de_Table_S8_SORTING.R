...
# -----------------------------------------------------------------------------
## POS
gsea.pos <- readTable(file.path(wd.de.gsea, "ALL_SORTING", "Table_S8", "gsea_report_for_na_pos_1661348670637.tsv"), header=T, rownames=F, sep="\t")
...
## NEG
gsea.neg <- readTable(file.path(wd.de.gsea, "ALL_SORTING", "Table_S8", "gsea_report_for_na_neg_1661348670637.tsv"), header=T, rownames=F, sep="\t")
...
gsea.neg <- gsea.neg[3:1, c("NAME", "NES")]
...
main.text <- c("Dong et al. gene sets NES                        ", "")
file.de <- file.path(wd.de.gsea, "LR_SORTING", "Table_S8_POS.pdf")
...
main.text <- c("", "")
file.de <- file.path(wd.de.gsea, "LR_SORTING", "Table_S8_NEG.pdf")
