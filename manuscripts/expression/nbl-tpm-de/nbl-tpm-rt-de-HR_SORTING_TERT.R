...
de <- getCannoli(file.path(wd.de.data, "2015"), BASE, 10, NULL, TEST="SORTING")
...
de <- getCannoli(file.path(wd.de.data, "2015"), BASE, 10, expressed, TEST="SORTING")
plot.de <- file.path(wd.de.plots, "2015", "cannoliplot_SRC_NBL-HR-TERT_TPM-CNA-SORTING_P1E03_MEDIAN0")
#genes <- readTable(paste0(plot.de, ".tab"), header=T, rownames=F, sep="\t")
file.de <- paste0(plot.de, ".pdf")
