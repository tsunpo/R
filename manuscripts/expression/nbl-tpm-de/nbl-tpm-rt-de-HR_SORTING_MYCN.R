...
## Testing for SORTING
samples.nbl.tpm.HR <- subset(samples.nbl.tpm, GROUP_ID3 == "MYCN")
...
writeTable(src.tpm.gene, file.path(wd.de.data, "2015", "SRC_NBL_tpm-gene_SORTING-vs-TPM_q_n9.txt"), colnames=T, rownames=F, sep="\t")
save(src.tpm.gene, samples.nbl.tpm.HR, file=file.path(wd.de.data, "2015", "SRC_NBL_tpm-gene_SORTING-vs-TPM_q_n9.RData"))
nrow(src.tpm.gene)
# [1] 28586
...
save(src.tpm.gene, samples, file=file.path(wd.de.data, "2015", "SRC_NBL_tpm-gene_CNA-vs-TPM_q_n9.RData"))
nrow(src.tpm.gene)
# [1] 31606
