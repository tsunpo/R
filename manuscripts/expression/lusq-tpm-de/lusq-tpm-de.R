...
samples <- readTable(file.path(wd.rna, "lusq_rna_n21.txt"), header=T, rownames=T, sep="")
...
writeTable(cbind(ensGene[rownames(tpm.gene.log2), c(1,7)], tpm.gene.log2), file.path(wd.de.data, "lusq_tpm-gene-log2_n21.txt"), colnames=T, rownames=F, sep="\t")
writeTable(cbind(ensGene[rownames(tpm.gene), c(1,7)], tpm.gene), file.path(wd.de.data, "lusq_tpm-gene_n21.txt"), colnames=T, rownames=F, sep="\t")
