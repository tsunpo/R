...
save(de.tpm.gene, samples, file=file.path(wd.de.data, "src_esad_tpm-gene-median0-median0-residual-pc1_TR-T-N_src_q_n68.RData"))
writeTable(de.tpm.gene, file.path(wd.de.data, "src_esad_tpm-gene-median0-median0-residual-pc1_TR-T-N_src_q_n68.txt"), colnames=T, rownames=F, sep="\t")
...
##
plot.main <- "319 additively expressed genes after treatment"
plot.de <- file.path(wd.de.plots, "volcanoplot_esad_median0_median0_residual_pc1_TR-T-N_p1e-6")
de.tpm.gene$LOG2_FC <- de.tpm.gene$FC_TR_N

genes <- readTable(paste0(plot.de, ".tab"), header=T, rownames=F, sep="\t")
file.main <- c(plot.main, "Between TR, T and N (controlled for cell cycle)")
...
reactome[6, 2] <- "Assembly of collagen fibrils and multimeric structures"
...
main.text <- c("Up-regulated pathways after treatment", "118 genes")
file.de <- file.path(wd.de.reactome, "genes_TR-T-N_res_p1e-6_n118_up.pdf")
