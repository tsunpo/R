...
save(de.tpm.gene, samples, file=file.path(wd.de.data, "src_esad_tpm-gene-median0-residual-pc2_N-B-X_src_q_n68.RData"))
writeTable(de.tpm.gene, file.path(wd.de.data, "src_esad_tpm-gene-median0-residual-pc2_N-B-X_src_q_n68.txt"), colnames=T, rownames=F, sep="\t")
