...
save(prin_comp, samples.filtered, so.integrated, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", 25, "_", 100, "_integrated_PCA_UMAP_", prin_comp, "_0.5_-C0.RData")))

##
file.name <- paste0("UMAP_SCT_", nfeatures, "_", 25, "_", 100, "_", prin_comp, "_0.5_-C0")
