...
# Save
outfile <- file.path(wd.de.plots, "origUM", paste0(GENE, "_prevalence_by_stage_misclass_corrected_S3.png"))
...
print(out, n = 12)
readr::write_csv(out, file.path(wd.de.plots, "origUM", paste0(GENE, "_prevalence_by_stage_misclass_corrected_S3.csv")))
...
outfile <- file.path(wd.de.plots, "origUM", paste0(GENE, "_prevalence_by_stage_misclass_corrected_3-bin_S3.png"))
...
outfile <- file.path(wd.de.plots, "origUM", paste0(GENE, "_prevalence_by_stage_misclass_corrected_4-bin_S3.png"))
...
save(calls, calls2, k_n_by_stage, fit1, fit3, fit4, fit12, res, file=file.path(wd.de.plots, "origUM", paste0("ssc_filtered_normalised_integrated_DF_SCT_PCA_UMAP_23_res=0.5_-C0_ordered_annotated_meta_cells_only_", GENE, "_CCF_S3.RData")))
