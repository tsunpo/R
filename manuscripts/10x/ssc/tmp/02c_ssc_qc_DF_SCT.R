...
so.integrated <- subset(so.integrated, idents != "0")
...
write.table(qced, file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_-C0.txt")), col.names=T, row.names=F, sep="\t")
...
save(prin_comp, samples.filtered, so.integrated, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, "_integrated_PCA_UMAP_", prin_comp, "_0.5_-C0.RData")))

##
file.name <- paste0("UMAP_SCT_", nfeatures, "_", dims, "_", k.weight, "_", prin_comp, "_0.5_-C0")
