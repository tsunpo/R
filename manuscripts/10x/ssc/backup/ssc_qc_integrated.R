...
save(filtered, normalised, samples0, samples0.filtered, so.integrated, file=file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated.RData"))
...
save(filtered, normalised, samples0, samples0.filtered, so.integrated, ids, ages, n2s, file=file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated.RData"))
...
# -----------------------------------------------------------------------------
load(file=file.path(wd.de.data, "ssc_filtered_normalised_vst.RData"))
load(file=file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated.RData"))
...
pdf(file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated_PCA_ElbowPlot.pdf"))
...
write.table(prin_comp, file=file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated_PCA.txt"),row.names=FALSE,col.names=FALSE,quote=FALSE,sep='\t')
save(filtered, normalised, samples0, samples0.filtered, so.integrated, pct, cumu, component1, component2, prin_comp, file=file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated_PCA.RData"))
...
load(file=file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated_PCA.RData"))
...
save(filtered, normalised, samples0, samples0.filtered, so.integrated, file=file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated_PCA_UMAP_dims=19_k=20_n=20.RData"))
...
save(filtered, normalised, samples0, samples0.filtered, so.integrated, file=file.path(wd.de.data, "ssc_filtered_normalised_vst_integrated_PCA_UMAP_dims=19_k=20_n=20_resolution=0.25.RData"))

##
pdf(file=file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_00.pdf"))
DimPlot(so.integrated, label = TRUE)
dev.off()

pdf(file=file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_sampleID.pdf"))
tplot = DimPlot(so.integrated, reduction = "umap", group.by="sample.id")
tplot[[1]]$layers[[1]]$aes_params$alpha = 0.5
print(tplot)
dev.off()

pdf(file=file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_Age.pdf"))
tplot = DimPlot(so.integrated, reduction = "umap", group.by="age")
tplot[[1]]$layers[[1]]$aes_params$alpha = 0.5
print(tplot)
dev.off()

pdf(file=file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_2N.pdf"))
...
pdf(file = file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_feature_plot_Marcrophase_Endothelial.pdf"), width = 14, height = 5)
print(feature_plot)
dev.off()
...
pdf(file = file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_feature_plot_SSC_differentiating.pdf"), width = 14, height = 5)
print(feature_plot)
dev.off()

feature_plot <- FeaturePlot(so.integrated, reduction = "umap", features = c("SYCP3", "SPO11", "MLH3", "SPAG6", "CAMK4", "ZPBP", "CREM", "TNP1", "PRM2"),	ncol = 5)
pdf(file = file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_feature_plot_Meiosis_Spermatid structure proteins_Nuclear condensation.pdf"), width = 14, height = 5)
print(feature_plot)
dev.off()
...
pdf(file = file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_feature_plot_ST4_SSC_State0.pdf"), width = 14, height = 5)
print(feature_plot)
dev.off()
...
pdf(file = file.path(wd.de.plots, "CCA_UMAP_dims=19_resolution=0.25_feature_plot_ST4_SSC_Stage1+2+3.pdf"), width = 14, height = 5)
print(feature_plot)
dev.off()
