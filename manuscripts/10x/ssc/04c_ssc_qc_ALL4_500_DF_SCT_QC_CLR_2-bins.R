...
# Print the plot
png(file = file.path(wd.de.plots, "2-bins_barplot_age_group_cell_type_DimPlot_5.3x7_seurat_clusters.png"), width = 5.3, height = 7, units = "in", res = 300)
print(plot)
dev.off()
...
# Print the plot
png(file = file.path(wd.de.plots, "2-bins_barplot_age_group_cell_type_DimPlot_cell_counts_5.3x7_seurat_clusters.png"), width = 5.3, height = 7, units = "in", res = 300)
print(plot)
dev.off()
...
# Print the plot
pdf(file = file.path(wd.de.plots, "2-bins_barplot_correlation_results_age_median_unsorted_seurat_clusters.pdf"), width = 6, height = 6)
print(plot)
dev.off()
...
# Print the plot
pdf(file = file.path(wd.de.plots, "2-bins_barplot_correlation_results_age_median_unsorted_seurat_clusters_CLR.pdf"), width = 6, height = 6)
print(plot)
dev.off()
