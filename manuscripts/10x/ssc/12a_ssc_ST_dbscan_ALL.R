...
# 1   spatial    5997          1775       7772  0.7716
# 2    dbscan    3977          3795       7772  0.5117
# 3       kde    5434          2338       7772  0.6992
...
pattern_counts
#                           pattern n_cells
# 1 spatial=NA | dbscan=NA | kde=NA    3416
# 2 spatial=NA | dbscan=OK | kde=NA    2018
# 3 spatial=OK | dbscan=OK | kde=OK    1775
# 4 spatial=NA | dbscan=NA | kde=OK     561
...
for (ct in all_ct) {
	...
	filename <- paste0("Spatial_ST_ALL_", safe_cell_type, "_dbscan.png")
...
filename <- paste0("Spatial_ST_ALL_dbscan_11x11_12.png")
ggsave(file.path(wd.de.plots, filename), plot = dim_plot, width = 11, height = 11, dpi = 300)
