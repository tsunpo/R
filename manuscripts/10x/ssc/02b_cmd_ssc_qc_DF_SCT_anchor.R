...
load(file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, ".RData")))
...
#save(samples.filtered, anchors, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_anchors.RData")))
load(file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_anchors.RData")))

so.integrated <- IntegrateData(anchorset = anchors, normalization.method = "SCT", dims = 1:dims, k.weight = k.weight)
save(samples.filtered, so.integrated, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, ".RData")))
...
save(samples.filtered, so.integrated, ids, ages, n2s, batches, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, "_integrated.RData")))
...
pdf(file.path(wd.de.data, paste0("ElbowPlot_ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, "_integrated.pdf")))
...
write.table(prin_comp, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, "_integrated_PCA.txt")), row.names=F, col.names=F, quote=F, sep='\t')
save(so.integrated, pct, cumu, component1, component2, prin_comp, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, "_integrated_PCA.RData")))
...
save(prin_comp, samples.filtered, so.integrated, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, "_integrated_PCA_UMAP_", prin_comp, ".RData")))
...
load(file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, "_integrated_PCA.RData")))
...
save(prin_comp, samples.filtered, so.integrated, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_DF_SCT_", nfeatures, "_", dims, "_", k.weight, "_integrated_PCA_UMAP_", prin_comp, "_0.5.RData")))

##
file.name <- paste0("UMAP_SCT_", nfeatures, "_", dims, "_", k.weight, "_", prin_comp, "_0.5")
