...
samples <- samples[rownames(subset(samples, Cell_Type %in% c("Spermatogonia_CD9_positive", "Spermatogonia_TA"))),]
...
trait.v <- c("Spermatogonia_TA", "Spermatogonia_CD9_positive")
cols    <- c(blue, red)
...
file.name <- paste0("DE_tpm-gene-median0_CD9-vs-TA_wilcox_q")
file.main <- paste0("CD9 vs. TA in ", BASE)
