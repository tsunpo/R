...
write.table(ssc0, file=file.path(wd.de.data, "ssc_samples_-5-21_>0.txt"), row.names=T, col.names=T, quote=F, sep='\t')
...
write.table(ssc, file=file.path(wd.de.data, "ssc_samples_-5-21_>100.txt"), row.names=T, col.names=T, quote=F, sep='\t')

save(ssc0, ssc, so.integrated, file=file.path(wd.de.data, "ssc_filtered_normalised_integrated_SCT_CCA_PCA_UMAP_resolution=0.5_5000_-5-21_>100.RData"))
...
new_order <- c("0", "15", "2", 23, "26", "17", "18", "6", "13", "14", "12", "24", "25", "19", "11", "7", "8", "3", "22", "9", "10", "21", "1", "16", "20", "5", "4")
