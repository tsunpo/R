...
save(samples0.filtered, so.integrated, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_SCT_RPCA_PCA_UMAP_", nfeatures, ".RData")))
...
load(file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_SCT_RPCA_PCA_", nfeatures, ".RData")))
load(file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_SCT_RPCA_PCA_UMAP_resolution=0.5_", nfeatures, ".RData")))
...
pdf(file = file.path(wd.de.plots, paste0("Di Persio_DotPlot_SCT_RPCA_", nfeatures, "_UMAP_dims=", prin_comp, "_resolution=0.5.pdf")), width = 14, height = 5)
print(dot_plot)
dev.off()
...
ggsave(filename = file.path(wd.de.plots, paste0("heatmap_top10_markers_SCT_RPCA_", nfeatures, "_UMAP_resolution=0.5.png")),
...
png(file = file.path(wd.de.plots, "heatmap_jaccard_markers_SCT_RPCA_res=0.5.png"), width = 7, height = 7, units = "in", res = 300)
print(pheatmap_plot)
dev.off()
