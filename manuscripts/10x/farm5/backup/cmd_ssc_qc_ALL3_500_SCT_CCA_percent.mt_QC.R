...
# -----------------------------------------------------------------------------
load(file=file.path(wd.de.data, "ssc_filtered_normalised_integrated_SCT_CCA_PCA_UMAP_resolution=0.5_5000_-12_>100.RData"))
...
save(so.integrated, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_SCT_CCA_", nfeatures, "_-12.RData")))
...
pdf(file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_ElbowPlot_SCT_CCA_", nfeatures, "_-12.pdf")))
...
save(so.integrated, pct, cumu, component1, component2, prin_comp, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_SCT_CCA_PCA_", nfeatures, "_-12.RData")))
...
save(so.integrated, prin_comp, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_SCT_CCA_PCA_UMAP_", nfeatures, "_-12.RData")))
...
##
file.name <- paste0("SCT_CCA_", nfeatures, "_UMAP_dims=", prin_comp, "_-12_resolution=0.5")
