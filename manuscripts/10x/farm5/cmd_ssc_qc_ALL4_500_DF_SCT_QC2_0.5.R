...
wd.de.data  <- file.path(wd.de, paste0("data_ALL4_500_QC2"))
wd.de.plots <- file.path(wd.de, paste0("plots_ALL4_500_QC2"))
...
nfeatures <- 5000
red <- 0.5
load(file=file.path(wd.de, "data_ALL4_500_QC", paste0("ssc_filtered_normalised_integrated_DF_SCT_PCA_UMAP_", nfeatures, "_-2_", 25, "_", 100, "-23.RData")))
...
save(anchors, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_DF_SCT_", nfeatures, "_", dims, "_anchors_-2-23_", dims, ".RData")))
...
save(so.integrated, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_DF_SCT_-2-23_", nfeatures, "_", dims, "_", k.weight, ".RData")))
...
pdf(file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_ElbowPlot_DF_SCT_", nfeatures, "_-2-23_", dims, "_", k.weight, ".pdf")))
...
save(so.integrated, pct, cumu, component1, component2, prin_comp, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_DF_SCT_PCA_", nfeatures, "_-2-23_", dims, "_", k.weight, ".RData")))
...
save(so.integrated, prin_comp, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_DF_SCT_PCA_UMAP_", nfeatures, "_-2-23_", dims, "_", k.weight, ".RData")))

# -----------------------------------------------------------------------------
# Define resolution
# Last Modified: 25/07/24
# -----------------------------------------------------------------------------
load(file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_DF_SCT_PCA_UMAP_", nfeatures, "_-2-23_", dims, "_", k.weight, ".RData")))
...
##
file.name <- paste0("SCT_", nfeatures, "_UMAP_dims=", prin_comp, "_-2-23_res=0.5_", dims, "_", k.weight)
