...
load(file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_DF_SCT_", nfeatures, "_", dims, "_anchors_-2-23_", dims, ".RData")))
...
write.table(prin_comp, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated_DF_SCT_PCA_", nfeatures, "_-2-23_", dims, "_", k.weight, ".txt")),row.names=F, col.names=F,quote=F,sep='\t')
