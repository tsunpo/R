...
samples.filtered <- samples.filtered[1:31,]
...
save(samples.filtered, features, so.list, file=file.path(wd.de.data, paste0("ssc_filtered_normalised_integrated0_DF_SCT_", nfeatures, "_so.list_Bush.RData")))
