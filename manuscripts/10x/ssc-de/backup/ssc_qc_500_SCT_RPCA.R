...
writeTable(normalised, file.path(wd.de.data, "ssc_filtered_normalised_SCT_14.txt"), colnames=T, rownames=F, sep="\t")
save(filtered, normalised, samples0, samples0.filtered, so.list, ids, genes, file=file.path(wd.de.data, "ssc_filtered_normalised_SCT_14.RData"))
...
new_order <- c("4", "19", "12", "13", "14", "2", "18", "8", "16", "17", "9", "15", "3", "5", "6", "10", "11", "1", "7", "0")
