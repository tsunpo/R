...
so.integrated <- FindClusters(so.integrated, algorithm=3, resolution = 0.45)
...
new_order <- c("0", "15", "19", "7", "20", "5", "14", "13", "3", "17", "16", "11", "10", "2", "4", "12", "9", "1", "18", "6", "8")
...
pdf(file = file.path(wd.de.plots, paste0("Di Persio_DotPlot_SCT_", nfeatures, "_SCT_dims=", prin_comp, "_resolution=0.45_ordered.pdf")), width = 14, height = 5)
print(dot_plot)
dev.off()
...
pdf(file = file.path(wd.de.plots, paste0("Di Persio_DotPlot_SCT_", nfeatures, "_SCT_dims=", prin_comp, "_resolution=0.45_ordered_annotated.pdf")), width = 12, height = 5)
print(dot_plot)
dev.off()

##
dim_plot <- DimPlot(so.integrated, label = TRUE)
ggsave(file.path(wd.de.plots, paste0("Di Persio_SCT_", nfeatures, "_UMAP_dims=14_resolution=0.45_ordered_annotated.png")), plot = dim_plot, width = 10, height = 8, dpi = 300)
...
cluster_to_celltype <- c('8' = 'Stage 0', '6' = 'Stage 0A', '18' = 'Stage 0B', '1' = 'Stage 1',
																									'9' = 'Stage 2', '24' = 'Stage 3',
																									'13' = 'Leptotene',
