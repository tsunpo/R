...
wd.de.data  <- file.path(wd.de, "data_ALL3_500_RPCA_vars.to.regress")
wd.de.plots <- file.path(wd.de, "plots_ALL3_500_RPCA_vars.to.regress")
...
proportion_data <- proportion_data[, c("seurat_clusters", "sample.id", "proportion")]
...
new_order <- c("13", "0", "1", "23", "21", "15", "3", "16", "5", "7", "18", "22", "9", "19", "24", "8", "14", "25", "12", "11", "6", "17", "4", "20", "10", "2")
