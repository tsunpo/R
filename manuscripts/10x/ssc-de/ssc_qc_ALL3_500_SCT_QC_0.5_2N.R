...
# Print the plot
png(file = file.path(wd.de.plots, "barplot_age_group_cell_type_DimPlot_2N.png"), width = 6, height = 7, , units = "in", res = 300)
print(plot)
dev.off()
...
# Print the plot
pdf(file = file.path(wd.de.plots, "correlation_results_age_median_2N.pdf"), width = 6, height = 6)
print(plot)
dev.off()
