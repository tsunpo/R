...
writeTable(normalised, file.path(wd.de.data, "ssc_filtered_normalised_M.txt"), colnames=T, rownames=F, sep="\t")
save(filtered, normalised, samples0, samples0.filtered, so.list, ids, genes, file=file.path(wd.de.data, "ssc_filtered_normalised_M.RData"))
...
save(filtered, normalised, samples0, samples0.filtered, so.merged, ids, ages, n2s, file=file.path(wd.de.data, "ssc_filtered_normalised_merged_M.RData"))
