...
pdf(file = file.path(wd.de.plots, paste0("Di Persio_DotPlot_SCT_", nfeatures, "_SCT_dims=", prin_comp, "_res=0.5_ordered_annotated.pdf")), width = 12, height = 5)
print(dot_plot)
dev.off()

##
dim_plot <- DimPlot(so.integrated, label = TRUE)
ggsave(file.path(wd.de.plots, paste0("Di Persio_SCT_", nfeatures, "_UMAP_dims=14_res=0.5_ordered_annotated.png")), plot = dim_plot, width = 10, height = 8, dpi = 300)
...
png(file = file.path(wd.de.plots, "heatmap_jaccard_markers_SCT_res=0.5_25_100.png"), width = 7, height = 7, units = "in", res = 300)
print(pheatmap_plot)
dev.off()
