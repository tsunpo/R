# =============================================================================
# Manuscript   : The dangeous case of DNA replication in NBL
...
# -----------------------------------------------------------------------------
#wd     <- "/ngs/cangen/tyang2/NBL/analysis/"                   ## tyang2@gauss
#wd.ngs <- "/ngs/cangen/tyang2/NBL/ngs/WGS/" 
wd     <- "/Users/tpyang/Work/uni-koeln/tyang2/NBL/analysis/"   ## tpyang@localhost
wd.ngs <- "/Users/tpyang/Work/uni-koeln/tyang2/NBL/ngs/WGS/"

wd.rt       <- paste0(wd, "replication/nbl-wgs-rt/")
wd.rt.data  <- paste0(wd.rt, "data/")
wd.rt.plots <- paste0(wd.rt, "plots/")
wd.asym       <- paste0(wd, "asymmetries/nbl-wgs-asym/")
...
ensGene.tx <- ensGene[rownames(tpm.gene.nbl),]
...
save(ensGene.tx.rt, file=paste0(wd.asym.data, "nbl_asym_tx_rt.RData"))
