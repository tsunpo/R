...
plotRT_WES <- function(file.name, main.text, chr, xmin, xmax, nrds.chr, bed.gc.chr, colours, legends, colours2, legends2, ext, width, peaks, ylim=NULL, lcl.rt.chr=NULL, nrds.lcl.chr=NULL, legend="topright") {
   ...
   bed.gc.chr <- bed.gc.chr[rownames(nrds.chr),]   ## BUT HERE?
   points(bed.gc.chr$START/1E6, nrds.chr$N, col=colours[2], pch=16, cex=0.3)   ## G1 first
   points(bed.gc.chr$START/1E6, nrds.chr$T, col=colours[1], pch=16, cex=0.3)   ## S next (on top)!
   ...
   idx <- which(nrds.chr$RT == 0)
   points(bed.gc.chr[idx,]$START/1E6, nrds.chr[idx,]$RT, col="lightgrey", cex=0.3)
   idx <- which(nrds.chr$RT < 0)
   points(bed.gc.chr[idx,]$START/1E6, nrds.chr[idx,]$RT, col=adjustcolor.blue, cex=0.3)
   idx <- which(nrds.chr$RT > 0)
   points(bed.gc.chr[idx,]$START/1E6, nrds.chr[idx,]$RT, col=adjustcolor.red, cex=0.3)
   ...
   points(bed.gc.chr$START/1E6, nrds.chr$RT, col="black", pch=16, cex=0.3)
